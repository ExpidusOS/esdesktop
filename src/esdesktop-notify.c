 ...
 *
 * NOTE: THIS FILE WAS COPIED FROM LUNAR. FUNCTION PREFIXES WERE
 * ALIGNED TO ESDESKTOP AND A FEW TRANSLATOR HINTS WERE ADDED.
 */
...
static gboolean esdesktop_notify_initted = FALSE;



static gboolean
esdesktop_notify_init (void)
{
  gchar *spec_version = NULL;

  if (!esdesktop_notify_initted
      && notify_init (PACKAGE_NAME))
    {
      ...
      esdesktop_notify_initted = TRUE;
    }

  return esdesktop_notify_initted;
}



void
esdesktop_notify_unmount (GMount *mount)
{
  ...
  if (read_only)
    {
      /* TRANSLATORS: Please use the same translation here as in Lunar */
  ...
  g_object_set_data_full (G_OBJECT (mount), "esdesktop-notification", notification,
                          g_object_unref);
...
void
esdesktop_notify_unmount_finish (GMount *mount, gboolean unmount_successful)
{
  const gchar * const *icon_names;
  NotifyNotification  *notification = NULL;
  const gchar         *summary;
  ...
  notification = g_object_get_data (G_OBJECT (mount), "esdesktop-notification");
  if (notification != NULL)
    {
      notify_notification_close (notification, NULL);
      g_object_set_data (G_OBJECT (mount), "esdesktop-notification", NULL);
    }
...
void
esdesktop_notify_eject (GVolume *volume)
{
  const gchar * const *icon_names;
  NotifyNotification  *notification = NULL;
  const gchar         *summary;
  ...
  g_object_set_data_full (G_OBJECT (volume), "esdesktop-notification", notification,
                          g_object_unref);
...
void
esdesktop_notify_eject_finish (GVolume *volume, gboolean eject_successful)
{
  const gchar * const *icon_names;
  NotifyNotification  *notification = NULL;
  const gchar         *summary;
  ...
  /* close any open notifications since the operation finished */
  notification = g_object_get_data (G_OBJECT (volume), "esdesktop-notification");
  if (notification != NULL)
    {
      notify_notification_close (notification, NULL);
      g_object_set_data (G_OBJECT (volume), "esdesktop-notification", NULL);
    }
