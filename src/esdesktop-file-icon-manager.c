...
#include "esdesktop-volume-icon.h"
...
typedef enum
{
    ...
    PROP_MAX_TEMPLATES,
} EsdesktopFileIconManagerProp;

typedef enum
{
    HIDDEN_STATE_CHANGED,
    LAST_SIGNAL,
} EsdesktopFileIconManagerSignals;


struct _EsdesktopFileIconManagerPrivate
{
    gboolean inited;
    ...
    GFile *folder;
    EsdesktopFileIcon *desktop_icon;
    ...
    gboolean show_special[ESDESKTOP_SPECIAL_FILE_ICON_TRASH+1];
...
#ifdef HAVE_LUNARX
    GList *lunarx_menu_providers;
    GList *lunarx_properties_providers;
#endif
...
static void esdesktop_file_icon_manager_set_property(GObject *object,
                                                     guint property_id,
                                                     const GValue *value,
                                                     GParamSpec *pspec);
static void esdesktop_file_icon_manager_get_property(GObject *object,
                                                     guint property_id,
                                                     GValue *value,
                                                     GParamSpec *pspec);
static void esdesktop_file_icon_manager_finalize(GObject *obj);
static void esdesktop_file_icon_manager_icon_view_manager_init(EsdesktopIconViewManagerIface *iface);

static gboolean esdesktop_file_icon_manager_real_init(EsdesktopIconViewManager *manager,
                                                      EsdesktopIconView *icon_view);
static void esdesktop_file_icon_manager_fini(EsdesktopIconViewManager *manager);

static gboolean esdesktop_file_icon_manager_drag_drop(EsdesktopIconViewManager *manager,
                                                      EsdesktopIcon *drop_icon,
                                                      GdkDragContext *context,
                                                      gint16 row,
                                                      gint16 col,
                                                      guint time_);
static void esdesktop_file_icon_manager_drag_data_received(EsdesktopIconViewManager *manager,
                                                           EsdesktopIcon *drop_icon,
                                                           GdkDragContext *context,
                                                           gint16 row,
                                                           gint16 col,
                                                           ...
                                                           guint info,
                                                           guint time_);
static void esdesktop_file_icon_manager_drag_data_get(EsdesktopIconViewManager *manager,
                                                      GList *drag_icons,
                                                      GdkDragContext *context,
                                                      GtkSelectionData *data,
                                                      guint info,
                                                      guint time_);
static GdkDragAction esdesktop_file_icon_manager_propose_drop_action(EsdesktopIconViewManager *manager,
                                                                     EsdesktopIcon *drop_icon,
...
static gboolean esdesktop_file_icon_manager_check_create_desktop_folder(GFile *file);
static void esdesktop_file_icon_manager_load_desktop_folder(EsdesktopFileIconManager *fmanager);
static void esdesktop_file_icon_manager_load_removable_media(EsdesktopFileIconManager *fmanager);
static void esdesktop_file_icon_manager_remove_removable_media(EsdesktopFileIconManager *fmanager);


static void esdesktop_file_icon_manager_set_show_special_file(EsdesktopFileIconManager *manager,
                                                              EsdesktopSpecialFileIconType type,
                                                              gboolean show_special_file);
static void esdesktop_file_icon_manager_set_show_thumbnails(EsdesktopFileIconManager *manager,
                                                            gboolean show_thumbnails);
static void esdesktop_file_icon_manager_set_show_hidden_files(EsdesktopFileIconManager *manager,
                                                              gboolean show_hidden_files);
static void esdesktop_file_icon_manager_set_show_removable_media(EsdesktopFileIconManager *manager,
                                                                 EsdesktopFileIconManagerProp prop,
                                                                 gboolean show);

static void esdesktop_file_icon_position_changed(EsdesktopFileIcon *icon,
                                                 gpointer user_data);

static void esdesktop_file_icon_manager_update_image(GtkWidget *widget,
                                                     gchar *srcfile,
                                                     gchar *thumbfile,
                                                     EsdesktopFileIconManager *fmanager);

static void
esdesktop_file_icon_manager_set_max_templates(EsdesktopFileIconManager *manager,
                                              gint max_templates);


G_DEFINE_TYPE_EXTENDED(EsdesktopFileIconManager,
                       esdesktop_file_icon_manager,
                       G_TYPE_OBJECT, 0,
                       G_IMPLEMENT_INTERFACE(ESDESKTOP_TYPE_ICON_VIEW_MANAGER,
                                             esdesktop_file_icon_manager_icon_view_manager_init)
                       G_ADD_PRIVATE(EsdesktopFileIconManager))
...
static EsdesktopClipboardManager *clipboard_manager = NULL;

static GQuark esdesktop_app_info_quark = 0;

static guint fmanager_signals[LAST_SIGNAL] = { 0, };


static void
esdesktop_file_icon_manager_class_init(EsdesktopFileIconManagerClass *klass)
{
    GObjectClass *gobject_class = (GObjectClass *)klass;

    gobject_class->set_property = esdesktop_file_icon_manager_set_property;
    gobject_class->get_property = esdesktop_file_icon_manager_get_property;
    gobject_class->finalize = esdesktop_file_icon_manager_finalize;

    fmanager_signals[HIDDEN_STATE_CHANGED] = g_signal_new("hidden-state-changed",
                                                          G_OBJECT_CLASS_TYPE(gobject_class),
                                                          G_SIGNAL_RUN_FIRST,
                                                          G_STRUCT_OFFSET(EsdesktopFileIconManagerClass, hidden_state_changed),
                                                          NULL, NULL,
...
#define ESDESKTOP_PARAM_FLAGS  (G_PARAM_READWRITE \
                                | G_PARAM_CONSTRUCT \
                                | G_PARAM_STATIC_NAME \
                                | G_PARAM_STATIC_NICK \
                                | G_PARAM_STATIC_BLURB)
    ...
    g_object_class_install_property(gobject_class, PROP_MAX_TEMPLATES,
                                    g_param_spec_uint("max-templates",
                                                      ...
                                                      0, G_MAXUSHORT, 16,
                                                      ESDESKTOP_PARAM_FLAGS));
#undef ESDESKTOP_PARAM_FLAGS

    esdesktop_app_info_quark = g_quark_from_static_string("esdesktop-app-info-quark");
}

static void
esdesktop_file_icon_manager_init(EsdesktopFileIconManager *fmanager)
{
    fmanager->priv = esdesktop_file_icon_manager_get_instance_private(fmanager);
    ...
    fmanager->priv->thumbnailer = esdesktop_thumbnailer_new();

    g_signal_connect(G_OBJECT(fmanager->priv->thumbnailer), "thumbnail-ready", G_CALLBACK(esdesktop_file_icon_manager_update_image), fmanager);
}

static void
esdesktop_file_icon_manager_set_property(GObject *object,
                                         guint property_id,
                                         const GValue *value,
                                         GParamSpec *pspec)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(object);

    switch(property_id) {
        case PROP_FOLDER:
            fmanager->priv->folder = g_value_dup_object(value);
            esdesktop_file_icon_manager_check_create_desktop_folder(fmanager->priv->folder);
            break;

        case PROP_SHOW_FILESYSTEM:
            esdesktop_file_icon_manager_set_show_special_file(fmanager,
        ...
        case PROP_SHOW_HOME:
            esdesktop_file_icon_manager_set_show_special_file(fmanager,
                                                              ESDESKTOP_SPECIAL_FILE_ICON_HOME,
                                                              g_value_get_boolean(value));
            break;
        ...
        case PROP_SHOW_UNKNOWN_VOLUME:
            esdesktop_file_icon_manager_set_show_removable_media(fmanager,
                                                                 property_id,
                                                                 g_value_get_boolean(value));
            break;

        case PROP_SHOW_THUMBNAILS:
            esdesktop_file_icon_manager_set_show_thumbnails(fmanager,
                                                            g_value_get_boolean(value));
            break;

        case PROP_SHOW_HIDDEN_FILES:
            esdesktop_file_icon_manager_set_show_hidden_files(fmanager,
                                                              g_value_get_boolean(value));
            break;

        case PROP_MAX_TEMPLATES:
            esdesktop_file_icon_manager_set_max_templates(fmanager,
...
static void
esdesktop_file_icon_manager_get_property(GObject *object,
                                         guint property_id,
                                         GValue *value,
                                         GParamSpec *pspec)
{
    ...
    switch(property_id) {
        ...
        case PROP_SHOW_FILESYSTEM:
            g_value_set_boolean(value,
                                fmanager->priv->show_special[ESDESKTOP_SPECIAL_FILE_ICON_FILESYSTEM]);
            break;

        case PROP_SHOW_HOME:
            g_value_set_boolean(value,
                                fmanager->priv->show_special[ESDESKTOP_SPECIAL_FILE_ICON_HOME]);
            break;

        case PROP_SHOW_TRASH:
            g_value_set_boolean(value,
                                fmanager->priv->show_special[ESDESKTOP_SPECIAL_FILE_ICON_TRASH]);
            break;
...
static void
esdesktop_file_icon_manager_finalize(GObject *obj)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(obj);

    if(fmanager->priv->inited)
        esdesktop_file_icon_manager_fini(ESDESKTOP_ICON_VIEW_MANAGER(fmanager));
    ...
    G_OBJECT_CLASS(esdesktop_file_icon_manager_parent_class)->finalize(obj);
}

static void
esdesktop_file_icon_manager_icon_view_manager_init(EsdesktopIconViewManagerIface *iface)
{
    iface->manager_init = esdesktop_file_icon_manager_real_init;
    iface->manager_fini = esdesktop_file_icon_manager_fini;
    iface->drag_drop = esdesktop_file_icon_manager_drag_drop;
    iface->drag_data_received = esdesktop_file_icon_manager_drag_data_received;
    iface->drag_data_get = esdesktop_file_icon_manager_drag_data_get;
    iface->propose_drop_action = esdesktop_file_icon_manager_propose_drop_action;
}

static gboolean
esdesktop_file_icon_manager_check_create_desktop_folder(GFile *folder)
{
    GFileInfo *info;
    GError *error = NULL;
    ...
    info = g_file_query_info(folder, ESDESKTOP_FILE_INFO_NAMESPACE,
    ...
    if(info == NULL) {
        if(!g_file_make_directory_with_parents(folder, NULL, &error)) {
            ...
            expidus_message_dialog(NULL, _("Desktop Folder Error"),
...
static void
esdesktop_file_icon_menu_executed(GtkWidget *widget,
                                  gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopIcon *icon;
    GList *selected;

    selected = esdesktop_icon_view_get_selected_items(fmanager->priv->icon_view);
    g_return_if_fail(g_list_length(selected) == 1);
    icon = ESDESKTOP_ICON(selected->data);
    g_list_free(selected);

    esdesktop_icon_activated(icon);
}

static void
esdesktop_file_icon_menu_open_all(GtkWidget *widget,
                                  gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GList *selected;
    ...
    g_list_foreach(selected, (GFunc)esdesktop_icon_activated, NULL);
    g_list_free(selected);
}

static void
esdesktop_file_icon_menu_rename(GtkWidget *widget,
                                gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    ...
    for(iter = selected; iter != NULL; iter = iter->next) {
        icon = ESDESKTOP_FILE_ICON(iter->data);

        /* create a list of GFiles from selected icons that can be renamed */
        if(esdesktop_file_icon_can_rename_file(icon))
            files = g_list_append(files, esdesktop_file_icon_peek_file(icon));
    }
    ...
    if(g_list_length(files) == 1) {
        ...
        esdesktop_file_utils_rename_file(g_list_first(files)->data,
                                         fmanager->priv->gscreen,
                                         GTK_WINDOW(toplevel));
    } else if(g_list_length(files) > 1) {
        /* Bulk rename for multiple icons selected */
        GFile *desktop = esdesktop_file_icon_peek_file(fmanager->priv->desktop_icon);

        esdesktop_file_utils_bulk_rename(desktop, files,
                                         fmanager->priv->gscreen,
                                         GTK_WINDOW(toplevel));
    } else {
        /* Nothing valid to rename */
        expidus_message_dialog(GTK_WINDOW(toplevel),
...
static void
esdesktop_file_icon_manager_delete_files(EsdesktopFileIconManager *fmanager,
                                         GList *files)
{
    ...
    for(lp = g_list_last(files); lp != NULL; lp = lp->prev)
        gfiles = g_list_prepend(gfiles, esdesktop_file_icon_peek_file(lp->data));

    esdesktop_file_utils_unlink_files(gfiles, fmanager->priv->gscreen,
                                      GTK_WINDOW(toplevel));
...
static gboolean
esdesktop_file_icon_manager_trash_files(EsdesktopFileIconManager *fmanager,
                                        GList *files)
{
    GtkWidget *toplevel = gtk_widget_get_toplevel(GTK_WIDGET(fmanager->priv->icon_view));
    GList *gfiles = NULL, *lp;
    ...
    esdesktop_file_utils_trash_files(gfiles, fmanager->priv->gscreen,
                                     GTK_WINDOW(toplevel));
...
static void
esdesktop_file_icon_manager_delete_selected(EsdesktopFileIconManager *fmanager,
                                            gboolean force_delete)
{
    ...
    for(l = selected; l; ) {
        if(!esdesktop_file_icon_can_delete_file(ESDESKTOP_FILE_ICON(l->data))) {
            GList *next = l->next;
    ...
    if (!force_delete) {
        esdesktop_file_icon_manager_trash_files(fmanager, selected);
    } else {
        esdesktop_file_icon_manager_delete_files(fmanager, selected);
    }
...
static void
esdesktop_file_icon_menu_app_info_executed(GtkWidget *widget,
                                           gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopFileIcon *icon;
    ...
    selected = esdesktop_icon_view_get_selected_items(fmanager->priv->icon_view);
    g_return_if_fail(g_list_length(selected) == 1);
    icon = ESDESKTOP_FILE_ICON(selected->data);
    g_list_free(selected);

    /* get the app info related to this menu item */
    app_info = g_object_get_qdata(G_OBJECT(widget), esdesktop_app_info_quark);
    if(!app_info)
        return;
    ...
    if(!esdesktop_file_utils_app_info_launch(app_info, fmanager->priv->folder, &files,
                                             G_APP_LAUNCH_CONTEXT(context), &error))
    {
        gchar *primary = g_markup_printf_escaped(_("Unable to launch \"%s\":"),
                                                 g_app_info_get_name(app_info));
        expidus_message_dialog(GTK_WINDOW(toplevel), _("Launch Error"),
...
static void
esdesktop_file_icon_menu_open_folder(GtkWidget *widget,
                                     gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopFileIcon *icon;
    ...
    esdesktop_file_utils_open_folder(file, fmanager->priv->gscreen,
                                     GTK_WINDOW(toplevel));
}

static void
esdesktop_file_icon_menu_open_desktop(GtkWidget *widget,
                                      gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopFileIcon *icon = fmanager->priv->desktop_icon;
    GFile *file;
    GtkWidget *toplevel;
...
static void
esdesktop_file_icon_menu_other_app(GtkWidget *widget,
                                   gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopFileIcon *icon;
    ...
    esdesktop_file_utils_display_chooser_dialog(file, TRUE,
                                                fmanager->priv->gscreen,
                                                GTK_WINDOW(toplevel));
}

static void
esdesktop_file_icon_menu_cut(GtkWidget *widget,
                             gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GList *files;

    files = esdesktop_icon_view_get_selected_items(fmanager->priv->icon_view);
    if(!files)
        return;

    esdesktop_clipboard_manager_cut_files(clipboard_manager, files);

    g_list_free(files);
}

static void
esdesktop_file_icon_menu_copy(GtkWidget *widget,
                              gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GList *files;
    ...
    esdesktop_clipboard_manager_copy_files(clipboard_manager, files);

    g_list_free(files);
}

static void
esdesktop_file_icon_menu_trash(GtkWidget *widget,
                               gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);

    esdesktop_file_icon_manager_delete_selected(fmanager, FALSE);
}

static void
esdesktop_file_icon_menu_delete(GtkWidget *widget,
                                gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);

    esdesktop_file_icon_manager_delete_selected(fmanager, TRUE);
}

static void
esdesktop_file_icon_menu_paste(GtkWidget *widget,
                               gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    if(widget && fmanager)
        esdesktop_clipboard_manager_paste_files(clipboard_manager, fmanager->priv->folder, widget, NULL);
}

static void
esdesktop_file_icon_menu_paste_into_folder(GtkWidget *widget,
                                           gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopFileIcon *icon;
    ...
    if (!fmanager || !ESDESKTOP_IS_FILE_ICON_MANAGER(fmanager))
        return;
    ...
    info = esdesktop_file_icon_peek_file_info(icon);
    ...
    if(widget)
        esdesktop_clipboard_manager_paste_files(clipboard_manager, file, widget, NULL);
}

static void
esdesktop_file_icon_menu_arrange_icons(GtkWidget *widget,
                                       gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    esdesktop_icon_view_sort_icons(fmanager->priv->icon_view);
}

static void
esdesktop_file_icon_menu_next_background(GtkWidget *widget,
                                         gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    expidus_desktop_refresh(EXPIDUS_DESKTOP(fmanager->priv->desktop), TRUE, FALSE);
}

static void
esdesktop_file_icon_menu_properties(GtkWidget *widget,
                                    gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GList *selected;
    ...
    esdesktop_file_utils_show_properties_dialog(file, fmanager->priv->gscreen,
                                                GTK_WINDOW(toplevel));
}

static void
esdesktop_file_icon_manager_desktop_properties(GtkWidget *widget,
                                               gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GtkWidget *parent = gtk_widget_get_toplevel(GTK_WIDGET(fmanager->priv->icon_view));
    GFile *file = esdesktop_file_icon_peek_file (fmanager->priv->desktop_icon);
...
static GtkWidget *
esdesktop_menu_item_from_app_info(EsdesktopFileIconManager *fmanager,
                                  EsdesktopFileIcon *icon,
                                  GAppInfo *app_info,
                                  ...
                                  gboolean with_title_prefix)
{
    ...
    if(with_mnemonic)
        mi = esdesktop_menu_create_menu_item_with_mnemonic(title, img);
    else
        mi = esdesktop_menu_create_menu_item_with_markup(title, img);
    g_free(title);

    g_object_set_qdata_full(G_OBJECT(mi), esdesktop_app_info_quark,
                            g_object_ref(app_info), g_object_unref);

    gtk_widget_show(mi);

    g_signal_connect(G_OBJECT(mi), "activate",
                     G_CALLBACK(esdesktop_file_icon_menu_app_info_executed),
                     fmanager);
...
static gboolean
esdesktop_file_icon_menu_free_icon_list_idled(gpointer user_data)
{
...
static void
esdesktop_file_icon_menu_free_icon_list(GtkMenu *menu,
                                        gpointer user_data)
{
    g_idle_add(esdesktop_file_icon_menu_free_icon_list_idled, user_data);
}

static void
esdesktop_file_icon_menu_create_launcher(GtkWidget *widget,
                                         gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GFile *file;
    ...
    if(file) {
        ...
        cmd = g_strdup_printf("endo-desktop-item-edit \"--display=%s\" \"%s\"",
                              display_name, uri);
    } else {
        const gchar *type = g_object_get_data(G_OBJECT(widget), "esdesktop-launcher-type");
        uri = g_file_get_uri(fmanager->priv->folder);
        if(G_UNLIKELY(!type))
            type = "Application";
        cmd = g_strdup_printf("endo-desktop-item-edit \"--display=%s\" --create-new --type %s \"%s\"",
                              display_name, type, uri);
    }

    if(!expidus_spawn_command_line_on_screen(NULL, cmd, FALSE, FALSE, &error)) {
        GtkWidget *toplevel = gtk_widget_get_toplevel(GTK_WIDGET(fmanager->priv->icon_view));
        expidus_message_dialog(GTK_WINDOW(toplevel), _("Launch Error"),
                            "dialog-error",
                            _("Unable to launch \"endo-desktop-item-edit\", which is required to create and edit launchers and links on the desktop."),
                            error->message,
                            EXPIDUS_BUTTON_TYPE_MIXED, "window-close", _("_Close"), GTK_RESPONSE_ACCEPT,
                            NULL);
    }
...
static void
esdesktop_file_icon_menu_create_folder(GtkWidget *widget,
                                       gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GtkWidget *toplevel;
    ...
    esdesktop_file_utils_create_file(fmanager->priv->folder, "inode/directory",
                                     fmanager->priv->gscreen,
                                     GTK_WINDOW(toplevel));
}

static void
esdesktop_file_icon_template_item_activated(GtkWidget *mi,
                                            gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    GtkWidget *toplevel;
    ...
    if(file) {
        esdesktop_file_utils_create_file_from_template(fmanager->priv->folder, file,
                                                       fmanager->priv->gscreen,
                                                        GTK_WINDOW(toplevel));
    } else {
        esdesktop_file_utils_create_file(fmanager->priv->folder, "text/plain",
                                         fmanager->priv->gscreen,
                                         GTK_WINDOW(toplevel));
    }
}
...
static void
esdesktop_file_icon_menu_fill_template_menu(GtkWidget *menu,
                                            GFile *template_dir,
                                            EsdesktopFileIconManager *fmanager,
                                            gboolean recursive)
{
    ...
    for(lp = files; lp != NULL; lp = lp->next) {
        ...
        if(g_file_info_get_file_type(info) == G_FILE_TYPE_DIRECTORY) {
            ...
            esdesktop_file_icon_menu_fill_template_menu(submenu, file,
                                                        fmanager, TRUE);
        ...
        item = esdesktop_menu_create_menu_item_with_markup(label, image);
        g_free(label);
        ...
        if(g_file_info_get_file_type(info) == G_FILE_TYPE_DIRECTORY)
            ...
            g_signal_connect(G_OBJECT(item), "activate",
                             G_CALLBACK(esdesktop_file_icon_template_item_activated),
                             fmanager);
        }
...
#ifdef HAVE_LUNARX
static void
lunarx_action_callback (GtkAction *action,
                         gpointer callback_data)
{
    lunarx_menu_item_activate (LUNARX_MENU_ITEM (callback_data));
}



static GtkWidget*
esdesktop_menu_create_menu_item_from_lunarx_menu_item (GObject *item)
{
    gchar *label, *icon_str;
    GtkWidget *mi, *img = NULL;

    g_return_val_if_fail (LUNARX_IS_MENU_ITEM (item), NULL);
    ...
    mi = esdesktop_menu_create_menu_item_with_mnemonic (label, img);

    g_signal_connect_data (mi, "activate",
                           G_CALLBACK (lunarx_action_callback),
                           g_object_ref (item),
...
static inline void
esdesktop_menu_shell_append_lunarx_menu_item_list(GtkMenuShell *menu_shell,
                                                   GList *items)
{
    GList *l;
    GtkWidget *mi;
    ...
    for(l = items; l; l = l->next) {
        mi = esdesktop_menu_create_menu_item_from_lunarx_menu_item (l->data);
        gtk_widget_show(mi);
...
static void
esdesktop_settings_launch(GtkWidget *w,
                          gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    gchar *cmd;
    ...
    cmd = g_find_program_in_path("esdesktop-settings");
    if(!cmd)
        cmd = g_strdup(BINDIR "/esdesktop-settings");

    if(!expidus_spawn_command_line_on_screen(fmanager->priv->gscreen, cmd, FALSE, TRUE, &error)) {
        GtkWidget *toplevel = gtk_widget_get_toplevel(GTK_WIDGET(fmanager->priv->icon_view));
...
static void
esdesktop_file_icon_manager_populate_context_menu(ExpidusDesktop *desktop,
                                                  GtkMenuShell *menu,
                                                  gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopFileIcon *file_icon = NULL;
    GFileInfo *info = NULL;
    ...
    info = esdesktop_file_icon_peek_file_info(file_icon);
    ...
    if(multi_sel) {
        ...
        for(l = selected; l != NULL; l = l->next) {
            if(ESDESKTOP_IS_SPECIAL_FILE_ICON(l->data)
               || ESDESKTOP_IS_VOLUME_ICON(l->data))
            {
    ...
    if(!multi_sel) {
        got_custom_menu = esdesktop_icon_populate_context_menu(ESDESKTOP_ICON(selected->data),
                                                               GTK_WIDGET(menu));
    }

    /* make sure icons don't get destroyed while menu is open */
    g_list_foreach(selected, (GFunc)g_object_ref, NULL);
    g_object_set_data(G_OBJECT(menu), "--esdesktop-icon-list", selected);
    g_signal_connect(G_OBJECT(menu), "deactivate",
                     G_CALLBACK(esdesktop_file_icon_menu_free_icon_list),
                     selected);

    if(!got_custom_menu) {
        if(multi_sel) {
            img = gtk_image_new_from_icon_name("document-open", GTK_ICON_SIZE_MENU);
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Open all"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            g_signal_connect(G_OBJECT(mi), "activate",
                             G_CALLBACK(esdesktop_file_icon_menu_open_all),
                             fmanager);
            ...
            if(g_file_info_get_file_type(info) == G_FILE_TYPE_DIRECTORY) {
                if(file_icon == fmanager->priv->desktop_icon) {
                    ...
                    mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Create _Launcher..."), img);
                    g_object_set_data(G_OBJECT(mi), "esdesktop-launcher-type", "Application");
                    gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                    gtk_widget_show(mi);

                    g_signal_connect(G_OBJECT(mi), "activate",
                                     G_CALLBACK(esdesktop_file_icon_menu_create_launcher),
                                     fmanager);
                    ...
                    img = gtk_image_new_from_gicon(icon, GTK_ICON_SIZE_MENU);
                    mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Create _URL Link..."), img);
                    g_object_set_data(G_OBJECT(mi), "esdesktop-launcher-type", "Link");
                    gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                    gtk_widget_show(mi);
                    ...
                    img = gtk_image_new_from_gicon(icon, GTK_ICON_SIZE_MENU);
                    mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Create _Folder..."), img);
                    gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                    gtk_widget_show(mi);

                    g_signal_connect(G_OBJECT(mi), "activate",
                                     G_CALLBACK(esdesktop_file_icon_menu_create_folder),
                                     fmanager);
                    ...
                    if(fmanager->priv->max_templates > 0) {
                        ...
                        mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Create _Document"), img);
                        gtk_widget_show(mi);
                        gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                         ...
                         * templates if so. */
                        home_dir = g_file_new_for_path(expidus_get_homedir());
                        ...
                        if(templates_dir && !g_file_equal(home_dir, templates_dir)) {
                            esdesktop_file_icon_menu_fill_template_menu(tmpl_menu,
                                                                        templates_dir,
                                                                        fmanager,
                                                                        FALSE);
                        }
                        ...
                        if(!gtk_container_get_children((GtkContainer*) tmpl_menu)) {
                            ...
                            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("No templates installed"), img);
                        ...
                        mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Empty File"), img);
                        gtk_widget_show(mi);
                        gtk_menu_shell_append(GTK_MENU_SHELL(tmpl_menu), mi);
                        g_signal_connect(G_OBJECT(mi), "activate",
                                         G_CALLBACK(esdesktop_file_icon_template_item_activated),
                    ...
                    gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                    g_signal_connect(G_OBJECT(mi), "activate",
                                     G_CALLBACK(esdesktop_file_icon_menu_open_folder),
                                     fmanager);
                }
                ...
                if(esdesktop_file_utils_file_is_executable(info)) {
                    ...
                    mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Execute"), img);
                    gtk_widget_show(mi);
                    gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);

                    g_signal_connect(G_OBJECT(mi), "activate",
                                     G_CALLBACK(esdesktop_file_icon_menu_executed),
                                     fmanager);
                                             ...
                                             "application/x-desktop"))
                    {
                        ...
                        mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Edit Launcher"), img);
                ...
                if(app_infos) {
                    ...
                    mi = esdesktop_menu_item_from_app_info(fmanager, file_icon,
                                                           app_info, TRUE, TRUE);
                    gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                    ...
                    if(app_infos->next) {
                        ...
                        if(list_len >= 3) {
                            img = gtk_image_new_from_icon_name("", GTK_ICON_SIZE_MENU);
                            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Open With"), img);
                            gtk_widget_show(mi);
                            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                        ...
                        for(l = app_infos->next; l; l = l->next) {
                            ...
                            mi = esdesktop_menu_item_from_app_info(fmanager,
                                                                   file_icon, app_info,
                                                                   FALSE, TRUE);
                    ...
                    img = gtk_image_new_from_icon_name("", GTK_ICON_SIZE_MENU);
                    mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Open With Other _Application..."), img);
                    gtk_widget_show(mi);
                    if(list_len >= 3)
                        gtk_menu_shell_append(GTK_MENU_SHELL(app_infos_menu), mi);
                    else
                        gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                    g_signal_connect(G_OBJECT(mi), "activate",
                                     G_CALLBACK(esdesktop_file_icon_menu_other_app),
                                     fmanager);
        ...
        if(file_icon == fmanager->priv->desktop_icon) {
            ...
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Paste"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            if(esdesktop_clipboard_manager_get_can_paste(clipboard_manager)) {
                g_signal_connect(G_OBJECT(mi), "activate",
                                 G_CALLBACK(esdesktop_file_icon_menu_paste),
                                 fmanager);
            } else
                gtk_widget_set_sensitive(mi, FALSE);
            ...
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Cu_t"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            if(multi_sel || esdesktop_file_icon_can_delete_file(file_icon)) {
                g_signal_connect(G_OBJECT(mi), "activate",
                                 G_CALLBACK(esdesktop_file_icon_menu_cut),
                                 fmanager);
            } else
                gtk_widget_set_sensitive(mi, FALSE);
            ...
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Copy"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            g_signal_connect(G_OBJECT(mi), "activate",
                             G_CALLBACK(esdesktop_file_icon_menu_copy),
                             fmanager);
            ...
            if(!multi_sel && info) {
                if(g_file_info_get_file_type(info) == G_FILE_TYPE_DIRECTORY
                   && g_file_info_get_attribute_boolean(info, G_FILE_ATTRIBUTE_ACCESS_CAN_WRITE)) {
                    img = gtk_image_new_from_icon_name("edit-paste", GTK_ICON_SIZE_MENU);
                    mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Paste Into Folder"), img);
                    gtk_widget_show(mi);
                    gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                    if(esdesktop_clipboard_manager_get_can_paste(clipboard_manager)) {
                        g_signal_connect(G_OBJECT(mi), "activate",
                                         G_CALLBACK(esdesktop_file_icon_menu_paste_into_folder),
                                         fmanager);
                    } else
                        gtk_widget_set_sensitive(mi, FALSE);
                }
            ...
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Mo_ve to Trash"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            if(multi_sel || esdesktop_file_icon_can_delete_file(file_icon)) {
                g_signal_connect(G_OBJECT(mi), "activate",
                                 G_CALLBACK(esdesktop_file_icon_menu_trash),
                                 fmanager);
            } else
                gtk_widget_set_sensitive(mi, FALSE);
            ...
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Delete"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            if(multi_sel || esdesktop_file_icon_can_delete_file(file_icon)) {
                g_signal_connect(G_OBJECT(mi), "activate",
                                 G_CALLBACK(esdesktop_file_icon_menu_delete),
                                 fmanager);
            } else
                gtk_widget_set_sensitive(mi, FALSE);
            ...
            /* Rename */
            img = gtk_image_new_from_icon_name("", GTK_ICON_SIZE_MENU);
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Rename..."), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            if(!multi_sel && esdesktop_file_icon_can_rename_file(file_icon)) {
                /* Rename a single icon */
                g_signal_connect(G_OBJECT(mi), "activate",
                                 G_CALLBACK(esdesktop_file_icon_menu_rename),
                                 fmanager);
            } else if(multi_sel) {
...
#ifdef HAVE_LUNARX
        if(!multi_sel_special && fmanager->priv->lunarx_menu_providers) {
            GList *menu_items = NULL;
            LunarxMenuProvider *provider;

            if(selected->data == fmanager->priv->desktop_icon) {
                /* click on the desktop itself, only show folder actions */
                for(l = fmanager->priv->lunarx_menu_providers; l; l = l->next) {
                    provider = LUNARX_MENU_PROVIDER(l->data);
                    menu_items = g_list_concat(menu_items,
                                                 lunarx_menu_provider_get_folder_menu_items(provider,
                                                                                             toplevel,
                                                                                             LUNARX_FILE_INFO(file_icon)));
                }
            } else {
                /* lunar file specific actions (allows them to operate on folders
                 * that are on the desktop as well) */
                for(l = fmanager->priv->lunarx_menu_providers; l; l = l->next) {
                    provider = LUNARX_MENU_PROVIDER(l->data);
                    menu_items = g_list_concat(menu_items,
                                                 lunarx_menu_provider_get_file_menu_items(provider,
                                                                                           toplevel,
                                                                                           selected));
                }
            }
            ...
            if(menu_items) {
                esdesktop_menu_shell_append_lunarx_menu_item_list(GTK_MENU_SHELL(menu),
                                                        menu_items);
        ...
        if(file_icon == fmanager->priv->desktop_icon) {
            /* Menu on the root desktop window */
            img = gtk_image_new_from_icon_name("document-open", GTK_ICON_SIZE_MENU);
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Open in New Window"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            g_signal_connect(G_OBJECT(mi), "activate",
                             G_CALLBACK(esdesktop_file_icon_menu_open_desktop),
                             fmanager);

            /* show arrange desktop icons option */
            img = gtk_image_new_from_icon_name("view-sort-ascending", GTK_ICON_SIZE_MENU);
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Arrange Desktop _Icons"), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            g_signal_connect(G_OBJECT(mi), "activate",
                             G_CALLBACK(esdesktop_file_icon_menu_arrange_icons),
                             fmanager);

            if(expidus_desktop_get_cycle_backdrop(EXPIDUS_DESKTOP(fmanager->priv->desktop))) {
                /* show next background option */
                img = gtk_image_new_from_icon_name("go-next", GTK_ICON_SIZE_MENU);
                mi = esdesktop_menu_create_menu_item_with_mnemonic(_("_Next Background"), img);
                gtk_widget_show(mi);
                gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
                g_signal_connect(G_OBJECT(mi), "activate",
                                 G_CALLBACK(esdesktop_file_icon_menu_next_background),
                                 fmanager);
            }

            /* Desktop settings window */
            img = gtk_image_new_from_icon_name("preferences-desktop-wallpaper", GTK_ICON_SIZE_MENU);
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("Desktop _Settings..."), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            g_signal_connect(G_OBJECT(mi), "activate",
                             G_CALLBACK(esdesktop_settings_launch), fmanager);
        } else {
            /* Properties - applies only to icons on the desktop */
            img = gtk_image_new_from_icon_name("document-properties", GTK_ICON_SIZE_MENU);
            mi = esdesktop_menu_create_menu_item_with_mnemonic(_("P_roperties..."), img);
            gtk_widget_show(mi);
            gtk_menu_shell_append(GTK_MENU_SHELL(menu), mi);
            if(multi_sel || !info)
                gtk_widget_set_sensitive(mi, FALSE);
                ...
                g_signal_connect(G_OBJECT(mi), "activate",
                                file_icon == fmanager->priv->desktop_icon
                                ? G_CALLBACK(esdesktop_file_icon_manager_desktop_properties)
                                : G_CALLBACK(esdesktop_file_icon_menu_properties),
                                fmanager);
            }
        }
    }
...
file_icon_hash_write_icons(gpointer key,
                           ...
                           gpointer data)
{
    ExpidusRc *rcfile = data;
    EsdesktopIcon *icon = value;
    gint16 row, col;
    gchar *identifier = esdesktop_icon_get_identifier(icon);

    if(esdesktop_icon_get_position(icon, &row, &col)) {
        /* Attempt to use the identifier, fall back to using the labels. */
        if(identifier)
            expidus_rc_set_group(rcfile, identifier);
        else
            expidus_rc_set_group(rcfile, esdesktop_icon_peek_label(icon));

        expidus_rc_write_int_entry(rcfile, "row", row);
        expidus_rc_write_int_entry(rcfile, "col", col);
    }
...
static gboolean
esdesktop_file_icon_manager_save_icons(gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    ...
    if (!esdesktop_get_workarea_single(fmanager->priv->icon_view,
                                       0,
                                       &x,
                                       &y,
                                       &width,
    ...
    g_snprintf(relpath, PATH_MAX, "expidus1/desktop/icons.screen%d-%dx%d.rc",
               0,
               width,
               height);

    path = expidus_resource_save_location(EXPIDUS_RESOURCE_CONFIG, relpath, TRUE);
    if(!path)
        return FALSE;
    ...
    rcfile = expidus_rc_simple_open(tmppath, FALSE);
    if(!rcfile) {
    ...
    expidus_rc_set_group(rcfile, ESDESKTOP_RC_VERSION_STAMP);
    expidus_rc_write_bool_entry(rcfile, "4.10.3+", TRUE);
    ...
    if(g_file_test(tmppath, G_FILE_TEST_EXISTS)) {
        if(rename(tmppath, path)) {
            ...
            last_path = expidus_resource_save_location(EXPIDUS_RESOURCE_CONFIG, "expidus1/desktop/icons.screen.latest.rc", TRUE);
            if(last_path != NULL) {
                unlink(last_path);
...
static void
esdesktop_file_icon_position_changed(EsdesktopFileIcon *icon,
                                     gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    ...
    fmanager->priv->save_icons_id = g_timeout_add(SAVE_DELAY,
                                                  esdesktop_file_icon_manager_save_icons,
                                                  fmanager);
}
...
void
esdesktop_file_icon_save(gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);

    if(fmanager->priv->pending_icons == NULL)
        esdesktop_file_icon_position_changed(NULL, user_data);
}

gboolean
esdesktop_file_icon_manager_get_cached_icon_position(EsdesktopFileIconManager *fmanager,
                                                     const gchar *name,
                                                     ...
                                                     gint16 *col)
{
    ...
    filename = expidus_resource_lookup(EXPIDUS_RESOURCE_CONFIG, relpath);

    /* Check if we have to migrate from the old file format */
    if(filename == NULL) {
        g_snprintf(relpath, PATH_MAX, "expidus1/desktop/icons.screen%d.rc", 0);
        filename = expidus_resource_lookup(EXPIDUS_RESOURCE_CONFIG, relpath);
    }

    /* Still nothing ? Just use the latest available file as fallback */
    if(filename == NULL) {
        filename = expidus_resource_lookup(EXPIDUS_RESOURCE_CONFIG, "expidus1/desktop/icons.screen.latest.rc");
    }

    if(filename != NULL) {
        ExpidusRc *rcfile;
        const gchar *icon_name;
        rcfile = expidus_rc_simple_open(filename, TRUE);

        /* Newer versions use the identifier rather than the icon label when
         * possible */
        if(expidus_rc_has_group(rcfile, ESDESKTOP_RC_VERSION_STAMP) && identifier)
            icon_name = identifier;
        else
            icon_name = name;

        if(expidus_rc_has_group(rcfile, icon_name)) {
            expidus_rc_set_group(rcfile, icon_name);
            *row = expidus_rc_read_int_entry(rcfile, "row", -1);
            *col = expidus_rc_read_int_entry(rcfile, "col", -1);
            if(*row >= 0 && *col >= 0)
                ret = TRUE;
        }
        expidus_rc_close(rcfile);
                     ...
                     GObject *obj)
{
    ...
    XF_DEBUG("icon finalized: '%s'", esdesktop_icon_peek_label(ESDESKTOP_ICON(obj)));
}
#endif

static void
esdesktop_file_icon_manager_queue_thumbnail(EsdesktopFileIconManager *fmanager,
                                            EsdesktopFileIcon *icon)
{
    GFile *file;
    gchar *path = NULL;
    ...
    if(fmanager->priv->show_thumbnails && path != NULL) {
        esdesktop_thumbnailer_queue_thumbnail(fmanager->priv->thumbnailer, path);
    }
...
static void
add_icon_to_iconview(EsdesktopFileIconManager *fmanager,
                     EsdesktopIcon *icon)
{
    /* Pay attention to position changes and add the icon to the icon view */
    g_signal_connect(G_OBJECT(icon), "position-changed",
                     G_CALLBACK(esdesktop_file_icon_position_changed),
                     fmanager);

    /* Tell the icon view about the icon */
    esdesktop_icon_view_add_item(fmanager->priv->icon_view,
                                 ESDESKTOP_ICON(icon));
...
process_icon_from_queue(gpointer user_data)
{
    ...
    g_return_val_if_fail(ESDESKTOP_IS_FILE_ICON_MANAGER(user_data), FALSE);

    fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    ...
    /* skip bad icons */
    if(icon == NULL || !ESDESKTOP_IS_FILE_ICON(icon))
        return TRUE;

    add_icon_to_iconview(fmanager, ESDESKTOP_ICON(icon));
...
static void
icon_view_resized(EsdesktopIconView *icon_view,
                  EsdesktopFileIconManager *fmanager)
{
    GQueue *new_queue;
    EsdesktopIcon *icon;
    ...
    if(!ESDESKTOP_IS_FILE_ICON_MANAGER(fmanager) || !ESDESKTOP_IS_ICON_VIEW(icon_view))
        return;
    ...
    while((icon = g_queue_pop_head(fmanager->priv->pending_icons))) {
        name = esdesktop_icon_peek_label(ESDESKTOP_ICON(icon));
        identifier = esdesktop_icon_get_identifier(ESDESKTOP_ICON(icon));

        if(esdesktop_file_icon_manager_get_cached_icon_position(fmanager,
                                                                name, identifier,
                                                                &row, &col))
        {
            ...
            esdesktop_icon_set_position(ESDESKTOP_ICON(icon), row, col);
...
static void
esdesktop_file_icon_manager_add_icon(EsdesktopFileIconManager *fmanager,
                                     EsdesktopFileIcon *icon,
                                     gint16 row, gint16 col)
{
    ...
    esdesktop_file_icon_manager_queue_thumbnail(fmanager, icon);
    ...
    if(row >= 0 && col >= 0) {
        ...
        esdesktop_icon_set_position(ESDESKTOP_ICON(icon), row, col);
        add_icon_to_iconview(fmanager, ESDESKTOP_ICON(icon));
    } else if(esdesktop_file_icon_manager_get_cached_icon_position(fmanager,
                                                                   name, identifier,
                                                                   &row, &col))
    {
    ...
    /* While esdesktop is idle we'll add icons to the icon view */
...
static void
esdesktop_file_icon_manager_remove_icon(EsdesktopFileIconManager *fmanager,
                                        EsdesktopFileIcon *icon)
{
    GList *item = NULL;

    g_return_if_fail(ESDESKTOP_IS_FILE_ICON_MANAGER(fmanager));
    ...
    if(item && item->data && ESDESKTOP_IS_FILE_ICON(item->data)) {
        gchar *filename = g_file_get_path(esdesktop_file_icon_peek_file(item->data));
        ...
        esdesktop_thumbnailer_dequeue_thumbnail(fmanager->priv->thumbnailer,
                                                filename);
        ...
        XF_DEBUG("removing icon %s from icon view", esdesktop_icon_peek_label(ESDESKTOP_ICON(icon)));
        /* Remove the icon from the icon_view */
        esdesktop_icon_view_remove_item(fmanager->priv->icon_view,
                                        ESDESKTOP_ICON(icon));
    }

    /* Remove the icon from the hash table */
    g_hash_table_remove(fmanager->priv->icons, esdesktop_file_icon_peek_file(icon));
}

/* If row and col are set then they will be used, otherwise set them to -1
 * and it will lookup the position in the rc file */
static EsdesktopFileIcon *
esdesktop_file_icon_manager_add_regular_icon(EsdesktopFileIconManager *fmanager,
                                             GFile *file,
                                             GFileInfo *info,
                                             gint16 row, gint16 col,
                                             gboolean defer_if_missing)
{
    EsdesktopRegularFileIcon *icon = NULL;
     ...
     * OnlyShowIn Or NotShowIn that would hide it from Expidus, don't
    ...
    if(is_desktop_file && !fmanager->priv->show_hidden_files)
    {
        ...
        if(rcfile) {
            ...
            if(expidus_rc_read_bool_entry(rcfile, "Hidden", FALSE)) {
                expidus_rc_close(rcfile);
                XF_DEBUG("Not adding icon because it has the Hidden Desktop Entry set");
                return NULL;
            }

            value = expidus_rc_read_entry(rcfile, "OnlyShowIn", NULL);
            if(value && strncmp(value, "EXPIDUS;", 5) && !strstr(value, ";EXPIDUS;")) {
                expidus_rc_close(rcfile);
                XF_DEBUG("Not adding icon because it has the OnlyShowIn Desktop Entry set");
                return NULL;
            }

            value = expidus_rc_read_entry(rcfile, "NotShowIn", NULL);
            if(value && (!strncmp(value, "EXPIDUS;", 5) || strstr(value, ";EXPIDUS;"))) {
                expidus_rc_close(rcfile);
    ...
    icon = esdesktop_regular_file_icon_new(file, info, fmanager->priv->gscreen, fmanager);

    esdesktop_file_icon_manager_add_icon(fmanager,
                                         ESDESKTOP_FILE_ICON(icon),
                                         row, col);

    g_hash_table_replace(fmanager->priv->icons, g_object_ref(file), icon);
    return ESDESKTOP_FILE_ICON(icon);
}

static EsdesktopFileIcon *
esdesktop_file_icon_manager_add_volume_icon(EsdesktopFileIconManager *fmanager,
                                            GVolume *volume)
{
    EsdesktopVolumeIcon *icon;
    gchar *volume_type;
    ...
    /* should never return NULL */
    icon = esdesktop_volume_icon_new(volume, fmanager->priv->gscreen);
...
static EsdesktopFileIcon *
esdesktop_file_icon_manager_add_special_file_icon(EsdesktopFileIconManager *fmanager,
                                                  EsdesktopSpecialFileIconType type)
{
    EsdesktopSpecialFileIcon *icon;

    /* can return NULL if it's the trash icon and dbus isn't around */
    icon = esdesktop_special_file_icon_new(type, fmanager->priv->gscreen);
    if(!icon)
        return NULL;
...
static gboolean
esdesktop_remove_icons_ht(gpointer key,
                          gpointer value,
                          gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopIcon *icon = ESDESKTOP_ICON(value);
    GList *item = NULL;
...
static void
esdesktop_file_icon_manager_refresh_icons(EsdesktopFileIconManager *fmanager)
{
    gint i;
    ...
    if(fmanager->priv->save_icons_id) {
        g_source_remove(fmanager->priv->save_icons_id);
        fmanager->priv->save_icons_id = 0;
        esdesktop_file_icon_manager_save_icons(fmanager);
    }

    /* ditch removable media */
    if(fmanager->priv->show_removable_media)
        esdesktop_file_icon_manager_remove_removable_media(fmanager);

    /* ditch special icons */
    for(i = 0; i <= ESDESKTOP_SPECIAL_FILE_ICON_TRASH; ++i) {
        EsdesktopIcon *icon = g_hash_table_lookup(fmanager->priv->special_icons,
                                                  GINT_TO_POINTER(i));
        if(icon) {
            esdesktop_icon_view_remove_item(fmanager->priv->icon_view, icon);
    ...
    if(fmanager->priv->icons) {
        g_hash_table_foreach_remove(fmanager->priv->icons,
                                    (GHRFunc)esdesktop_remove_icons_ht,
                                    fmanager);
    }

#if defined(DEBUG) && DEBUG > 0
    g_assert(_esdesktop_icon_view_n_items(fmanager->priv->icon_view) == 0);
    g_assert(g_list_length(_alive_icon_list) == 0);
#endif

    /* clear out anything left in the icon view */
    esdesktop_icon_view_remove_all(fmanager->priv->icon_view);

    /* add back the special icons */
    for(i = 0; i <= ESDESKTOP_SPECIAL_FILE_ICON_TRASH; ++i) {
        if(fmanager->priv->show_special[i])
            esdesktop_file_icon_manager_add_special_file_icon(fmanager, i);
    }

    /* add back removable media */
    if(fmanager->priv->show_removable_media)
        esdesktop_file_icon_manager_load_removable_media(fmanager);

    /* reload and add ~/Desktop/ */
    esdesktop_file_icon_manager_load_desktop_folder(fmanager);
}

static gboolean
esdesktop_file_icon_manager_key_press(GtkWidget *widget,
                                      GdkEventKey *evt,
                                      gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    ...
    switch(evt->keyval) {
        ...
        case GDK_KEY_KP_Delete:
            if(evt->state & GDK_SHIFT_MASK)
                force_delete = TRUE;
            esdesktop_file_icon_manager_delete_selected(fmanager, force_delete);
            break;
        ...
        case GDK_KEY_C:
            ...
            selected = esdesktop_icon_view_get_selected_items(fmanager->priv->icon_view);
            if(selected) {
                esdesktop_clipboard_manager_copy_files(clipboard_manager,
                                                       selected);
                g_list_free(selected);
            }
            break;
        ...
        case GDK_KEY_X:
            ...
            selected = esdesktop_icon_view_get_selected_items(fmanager->priv->icon_view);
            if(selected) {
                esdesktop_clipboard_manager_cut_files(clipboard_manager,
                                                       selected);
                g_list_free(selected);
            }
            return TRUE;
        ...
        case GDK_KEY_N:
            ...
            esdesktop_file_icon_menu_create_folder(NULL, fmanager);
            return TRUE;
        ...
        case GDK_KEY_R:
            ...
            /* fall through */
        case GDK_KEY_F5:
            esdesktop_file_icon_manager_refresh_icons(fmanager);
            return TRUE;

        case GDK_KEY_F2:
            selected = esdesktop_icon_view_get_selected_items(fmanager->priv->icon_view);
            if(g_list_length(selected) == 1) {
                EsdesktopFileIcon *icon = ESDESKTOP_FILE_ICON(selected->data);
                if(esdesktop_file_icon_can_rename_file(icon)) {
                    esdesktop_file_icon_menu_rename(NULL, fmanager);
                    return TRUE;
                }
            }
            if(selected)
...
static void
esdesktop_file_icon_manager_file_changed(GFileMonitor     *monitor,
                                         GFile            *file,
                                         GFile            *other_file,
...
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    EsdesktopFileIcon *icon, *moved_icon;
    GFileInfo *file_info;
    gint16 row = 0, col = 0;
    gchar *filename;
    ...
    switch(event) {
        ...
        case G_FILE_MONITOR_EVENT_MOVED_OUT:
            ...
            if(icon) {
                ...
                /* Remove the old icon */
                esdesktop_file_icon_manager_remove_icon(fmanager, icon);
            }
            ...
            file_info = g_file_query_info(other_file, ESDESKTOP_FILE_INFO_NAMESPACE,
                                            G_FILE_QUERY_INFO_NONE, NULL, NULL);
            ...
            if(moved_icon) {
                 ...
                 * to use instead */
                if(!esdesktop_icon_get_position(ESDESKTOP_ICON(moved_icon), &row, &col)) {
                    /* Failed to get position... not supported? */
                    row = col = 0;
                }
                XF_DEBUG("row %d, col %d", row, col);

                esdesktop_file_icon_manager_remove_icon(fmanager, moved_icon);
            }

            if(esdesktop_compare_paths(g_file_get_parent(other_file), fmanager->priv->folder)) {
            ...
            if(file_info) {
                ...
                icon = esdesktop_file_icon_manager_add_regular_icon(fmanager,
                                                                    other_file,
                                                                    file_info,
                                                                    row,
                                                                    col,
                                                                    FALSE);
                if(icon)
                    esdesktop_file_icon_position_changed(icon, fmanager);
        ...
        case G_FILE_MONITOR_EVENT_CHANGES_DONE_HINT:
            ...
            icon = g_hash_table_lookup(fmanager->priv->icons, file);
            if(icon) {
                file_info = g_file_query_info(file, ESDESKTOP_FILE_INFO_NAMESPACE,
                                              G_FILE_QUERY_INFO_NONE, NULL, NULL);

                if(file_info) {
                    /* update the icon if the file still exists */
                    esdesktop_file_icon_update_file_info(icon, file_info);
                    g_object_unref(file_info);
        ...
        case G_FILE_MONITOR_EVENT_CREATED:
            ...
            file_info = g_file_query_info(file, ESDESKTOP_FILE_INFO_NAMESPACE,
                                          G_FILE_QUERY_INFO_NONE, NULL, NULL);
            if(file_info) {
                esdesktop_file_icon_manager_add_regular_icon(fmanager,
                                                             file, file_info,
                                                             -1, -1,
                                                             TRUE);
        ...
        case G_FILE_MONITOR_EVENT_DELETED:
            ...
            if(icon) {
                ...
                if(item) {
                    ...
                    esdesktop_thumbnailer_delete_thumbnail(fmanager->priv->thumbnailer,
                                                           filename);
                ...
                esdesktop_file_icon_position_changed(NULL, fmanager);
            } else {
...
static void
esdesktop_file_icon_manager_update_file_info(gpointer key,
                                             gpointer value,
                                             gpointer user_data)
{
    EsdesktopFileIcon *icon = ESDESKTOP_FILE_ICON(value);
    GFileInfo *file_info;

    if(icon) {
        file_info = g_file_query_info(key, ESDESKTOP_FILE_INFO_NAMESPACE,
                                      G_FILE_QUERY_INFO_NONE, NULL, NULL);
...
static gboolean
esdesktop_file_icon_manager_metadata_timer(gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);

    g_hash_table_foreach(fmanager->priv->icons,
                         (GHFunc)esdesktop_file_icon_manager_update_file_info,
                         fmanager);
...
static void
esdesktop_file_icon_manager_metadata_changed(GFileMonitor     *monitor,
                                             GFile            *file,
                                             GFile            *other_file,
                                             GFileMonitorEvent event,
                                             gpointer          user_data)
{
    ...
    /* Sanity check */
    if(user_data == NULL || !ESDESKTOP_IS_FILE_ICON_MANAGER(user_data))
        return;
    ...
    timer = g_timeout_add_seconds(5, esdesktop_file_icon_manager_metadata_timer, fmanager);

    fmanager->priv->metadata_timer = timer;
}

static void
esdesktop_file_icon_manager_files_ready(GFileEnumerator *enumerator,
                                        GAsyncResult *result,
                                        gpointer user_data)
{
    EsdesktopFileIconManager *fmanager;
    ...
    if(!files) {
        if(error) {
            ...
            expidus_message_dialog(gtk_widget_is_toplevel(toplevel) ? GTK_WINDOW(toplevel) : NULL,
                                _("Load Error"),
                                "dialog-warning",
        ...
        if(!fmanager->priv->monitor) {
            ...
            g_signal_connect(fmanager->priv->monitor, "changed",
                             G_CALLBACK(esdesktop_file_icon_manager_file_changed),
                             fmanager);
        }
        ...
        if(!fmanager->priv->metadata_monitor) {
            gchar *location = expidus_resource_lookup(EXPIDUS_RESOURCE_DATA, "gvfs-metadata/");
            ...
            g_signal_connect(fmanager->priv->metadata_monitor, "changed",
                             G_CALLBACK(esdesktop_file_icon_manager_metadata_changed),
                             fmanager);
        ...
        g_file_enumerator_next_files_async(fmanager->priv->enumerator,
                                           ...
                                           (GAsyncReadyCallback) esdesktop_file_icon_manager_files_ready,
                                           fmanager);
    }
}

static void
esdesktop_file_icon_manager_load_desktop_folder(EsdesktopFileIconManager *fmanager)
{
...
static void
esdesktop_file_icon_manager_check_icons_opacity(gpointer key,
                                                gpointer value,
                                                gpointer data)
{
    EsdesktopRegularFileIcon *icon = ESDESKTOP_REGULAR_FILE_ICON(value);
    EsdesktopClipboardManager *cmanager = ESDESKTOP_CLIPBOARD_MANAGER(data);

    if(G_UNLIKELY(esdesktop_clipboard_manager_has_cutted_file(cmanager, ESDESKTOP_FILE_ICON(icon))))
        esdesktop_regular_file_icon_set_pixbuf_opacity(icon, 50);
    else
        esdesktop_regular_file_icon_set_pixbuf_opacity(icon, 100);
}

static void
esdesktop_file_icon_manager_clipboard_changed(EsdesktopClipboardManager *cmanager,
                                              gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
    ...
    /* slooow? */
    g_hash_table_foreach(fmanager->priv->icons,
                         esdesktop_file_icon_manager_check_icons_opacity,
                         cmanager);
}

static void
esdesktop_file_icon_manager_add_removable_volume(EsdesktopFileIconManager *fmanager,
                                                 GVolume *volume)
{
    esdesktop_file_icon_manager_add_volume_icon(fmanager, volume);
}

static void
esdesktop_file_icon_manager_volume_added(GVolumeMonitor *monitor,
                                         GVolume *volume,
                                         gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);

    esdesktop_file_icon_manager_add_removable_volume(fmanager, volume);
}

static void
esdesktop_file_icon_manager_volume_removed(GVolumeMonitor *monitor,
                                           GVolume *volume,
                                           gpointer user_data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(user_data);
...
static void
esdesktop_file_icon_manager_load_removable_media(EsdesktopFileIconManager *fmanager)
{
    GList *volumes, *l;
    ...
    for(l = volumes; l; l = l->next) {
        esdesktop_file_icon_manager_add_removable_volume(fmanager, l->data);
        g_object_unref(l->data);
    }
    g_list_free(volumes);

    g_signal_connect(G_OBJECT(fmanager->priv->volume_monitor), "volume-added",
                     G_CALLBACK(esdesktop_file_icon_manager_volume_added),
                     fmanager);
    g_signal_connect(G_OBJECT(fmanager->priv->volume_monitor), "volume-removed",
                     G_CALLBACK(esdesktop_file_icon_manager_volume_removed),
                     fmanager);
}

static void
esdesktop_file_icon_manager_ht_remove_removable_media(gpointer key,
                                                      gpointer value,
                                                      gpointer user_data)
{
    EsdesktopIcon *icon = ESDESKTOP_ICON(value);
...
static void
esdesktop_file_icon_manager_remove_removable_media(EsdesktopFileIconManager *fmanager)
{
    if(fmanager->priv->removable_icons) {
        g_hash_table_foreach(fmanager->priv->removable_icons,
                             esdesktop_file_icon_manager_ht_remove_removable_media,
                             fmanager);
...
static gboolean
esdesktop_file_icon_manager_real_init(EsdesktopIconViewManager *manager,
                                      EsdesktopIconView *icon_view)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(manager);
    GFileInfo *desktop_info;
    gint i;
#ifdef HAVE_LUNARX
    LunarxProviderFactory *lunarx_pfac;
#endif
    ...
    g_signal_connect(G_OBJECT(fmanager->priv->desktop), "populate-root-menu",
                     G_CALLBACK(esdesktop_file_icon_manager_populate_context_menu),
                     fmanager);
    ...
    if(!clipboard_manager) {
        ...
        clipboard_manager = esdesktop_clipboard_manager_get_for_display(gdpy);
    ...
    g_signal_connect(G_OBJECT(clipboard_manager), "changed",
                     G_CALLBACK(esdesktop_file_icon_manager_clipboard_changed),
                     fmanager);

    esdesktop_icon_view_set_selection_mode(icon_view, GTK_SELECTION_MULTIPLE);
    esdesktop_icon_view_enable_drag_source(icon_view,
                                           GDK_SHIFT_MASK | GDK_CONTROL_MASK
                                           | GDK_BUTTON1_MASK,
                                           drag_targets, n_drag_targets,
                                           GDK_ACTION_LINK | GDK_ACTION_COPY
                                           | GDK_ACTION_MOVE);
    esdesktop_icon_view_enable_drag_dest(icon_view, drop_targets,
                                         n_drop_targets, GDK_ACTION_LINK
                                         | GDK_ACTION_COPY | GDK_ACTION_MOVE);

    g_signal_connect(G_OBJECT(esdesktop_icon_view_get_window_widget(icon_view)),
                     "key-press-event",
                     G_CALLBACK(esdesktop_file_icon_manager_key_press),
                     fmanager);
    ...
    if(!esdesktop_file_utils_dbus_init())
        g_warning("Unable to initialise D-Bus.  Some esdesktop features may be unavailable.");

    /* do this in the reverse order stuff should be displayed */
    esdesktop_file_icon_manager_load_desktop_folder(fmanager);
    if(fmanager->priv->show_removable_media)
        esdesktop_file_icon_manager_load_removable_media(fmanager);
    for(i = ESDESKTOP_SPECIAL_FILE_ICON_TRASH; i >= 0; --i) {
        if(fmanager->priv->show_special[i])
            esdesktop_file_icon_manager_add_special_file_icon(fmanager, i);
    }

#ifdef HAVE_LUNARX
    lunarx_pfac = lunarx_provider_factory_get_default();

    fmanager->priv->lunarx_menu_providers =
        lunarx_provider_factory_list_providers(lunarx_pfac,
                                                LUNARX_TYPE_MENU_PROVIDER);
    fmanager->priv->lunarx_properties_providers =
        lunarx_provider_factory_list_providers(lunarx_pfac,
                                                LUNARX_TYPE_PROPERTY_PAGE_PROVIDER);

    g_object_unref(G_OBJECT(lunarx_pfac));
#endif
    ...
    fmanager->priv->desktop_icon = ESDESKTOP_FILE_ICON(esdesktop_regular_file_icon_new(fmanager->priv->folder,
                                                                                       desktop_info,
                                                                                       fmanager->priv->gscreen,
                                                                                       fmanager));
...
static void
esdesktop_file_icon_manager_fini(EsdesktopIconViewManager *manager)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(manager);
    gint i;
...
#ifdef HAVE_LUNARX
    g_list_foreach(fmanager->priv->lunarx_menu_providers,
                   (GFunc)g_object_unref, NULL);
    g_list_free(fmanager->priv->lunarx_menu_providers);

    g_list_foreach(fmanager->priv->lunarx_properties_providers,
                   (GFunc)g_object_unref, NULL);
    g_list_free(fmanager->priv->lunarx_properties_providers);
#endif
    ...
    esdesktop_file_utils_dbus_cleanup();

    g_signal_handlers_disconnect_by_func(G_OBJECT(esdesktop_icon_view_get_window_widget(fmanager->priv->icon_view)),
                                         G_CALLBACK(esdesktop_file_icon_manager_key_press),
                                         fmanager);

    esdesktop_icon_view_unset_drag_source(fmanager->priv->icon_view);
    esdesktop_icon_view_unset_drag_dest(fmanager->priv->icon_view);
}

static gboolean
esdesktop_file_icon_manager_drag_drop(EsdesktopIconViewManager *manager,
                                      EsdesktopIcon *drop_icon,
                                      GdkDragContext *context,
                                      gint16 row,
                                      gint16 col,
                                      guint time_)
{
    ...
    if(target == GDK_NONE)
         ...
         * Lunar, Copyright (c) Benedikt Meurer */
        gint prop_len;
        ...
        if(drop_icon) {
            GFileInfo *info = esdesktop_file_icon_peek_file_info(ESDESKTOP_FILE_ICON(drop_icon));
            if(!info)
                return FALSE;
            ...
            source_file = esdesktop_file_icon_peek_file(ESDESKTOP_FILE_ICON(drop_icon));
...
static void esdesktop_dnd_item(GtkWidget *item, GdkDragAction *action)
{
    *action = GPOINTER_TO_UINT(g_object_get_data(G_OBJECT(item), "action"));
}

static void esdesktop_dnd_item_cancel(GtkWidget *item, GdkDragAction *action)
{
    *action = 0;
}
...
/**
 * esdesktop_dnd_menu:
 * @manager     : the #EsdesktopIconViewManager instance
 * @drop_icon   : the #EsdesktopIcon to which is being dropped.
 ...
 * Portions of this code was copied from lunar-dnd.c
                         ...
                         guint time_)
{
    ...
    for(menu_item = 0; menu_item < G_N_ELEMENTS(actions); menu_item++) {
        ...
        item = esdesktop_menu_create_menu_item_with_mnemonic(_(action_names[menu_item]), image);
        gtk_menu_shell_append(GTK_MENU_SHELL(menu), item);
        g_signal_connect(G_OBJECT(item), "activate", G_CALLBACK(esdesktop_dnd_item), &response);
    ...
    item = esdesktop_menu_create_menu_item_with_mnemonic(_("_Cancel"), image);
    gtk_menu_shell_append(GTK_MENU_SHELL(menu), item);
    g_signal_connect(G_OBJECT(item), "activate", G_CALLBACK(esdesktop_dnd_item_cancel), &response);
    gtk_widget_show(item);
    ...
    expidus_gtk_menu_popup_until_mapped(GTK_MENU(menu), NULL, NULL, NULL, NULL, 3, time_);
...
static void
esdesktop_file_icon_manager_drag_data_received(EsdesktopIconViewManager *manager,
                                               EsdesktopIcon *drop_icon,
                                               GdkDragContext *context,
                                               gint16 row,
                                               gint16 col,
                                               ...
                                               guint time_)
{
    ...
    if(action == GDK_ACTION_ASK) {
        esdesktop_dnd_menu(manager, drop_icon, context, &action, row, col, time_);
    ...
    if(info == TARGET_XDND_DIRECT_SAVE0) {
        ...
        gchar *endo_desktop_item_edit = g_find_program_in_path("endo-desktop-item-edit");

        if(drop_icon) {
            GFileInfo *finfo = esdesktop_file_icon_peek_file_info(ESDESKTOP_FILE_ICON(drop_icon));
            if(g_file_info_get_file_type(finfo) == G_FILE_TYPE_DIRECTORY)
                source_file = esdesktop_file_icon_peek_file(ESDESKTOP_FILE_ICON(drop_icon));
        } else
            source_file = fmanager->priv->folder;

        if(source_file && endo_desktop_item_edit) {
            ...
            if(2 == g_strv_length(parts)) {
                 ...
                 * the link title */
                myargv[i++] = endo_desktop_item_edit;
                myargv[i++] = "--type=Link";
                myargv[i++] = "--url";
                myargv[i++] = parts[0];
                myargv[i++] = "--name";
                ...
                if(expidus_spawn_on_screen(fmanager->priv->gscreen, NULL, myargv,
        ...
        if(drop_icon) {
            file_icon = ESDESKTOP_FILE_ICON(drop_icon);
            tfile = esdesktop_file_icon_peek_file(file_icon);
            tinfo = esdesktop_file_icon_peek_file_info(file_icon);
        }
        ...
        file_list = esdesktop_file_utils_file_list_from_string((const gchar *)gtk_selection_data_get_data(data));
        if(file_list) {
            GtkWidget *toplevel = gtk_widget_get_toplevel(GTK_WIDGET(fmanager->priv->icon_view));

            if(tinfo && esdesktop_file_utils_file_is_executable(tinfo)) {
                drop_ok = esdesktop_file_utils_execute(fmanager->priv->folder,
                                                       tfile, file_list,
                                                       fmanager->priv->gscreen,
                                                       GTK_WINDOW(toplevel));
            } else if(tfile && g_file_has_uri_scheme(tfile, "trash")) {
                /* move files to the trash */
                esdesktop_file_utils_trash_files(file_list,
                                                 fmanager->priv->gscreen,
                                                 GTK_WINDOW(toplevel));
            } else {
                ...
                gboolean dest_is_volume = (drop_icon
                                           && ESDESKTOP_IS_VOLUME_ICON(drop_icon));
                ...
                if(dest_file_list) {
                    ...
                    drop_ok = esdesktop_file_utils_transfer_files(action,
                                                                  file_list,
                                                                  dest_file_list,
                                                                  fmanager->priv->gscreen);
                }
                ...
                if(copy_only) {
                    esdesktop_file_utils_file_list_free(dest_file_list);
                } else {
...
static void
esdesktop_file_icon_manager_drag_data_get(EsdesktopIconViewManager *manager,
                                          GList *drag_icons,
                                          GdkDragContext *context,
                                          GtkSelectionData *data,
                                          guint info,
                                          guint time_)
{
    ...
    file_list = esdesktop_file_utils_file_icon_list_to_file_list(drag_icons);
    str = esdesktop_file_utils_file_list_to_string(file_list);
...
esdesktop_file_icon_manager_propose_drop_action(EsdesktopIconViewManager *manager,
                                                EsdesktopIcon *drop_icon,
                                                GdkDragAction action,
                                                GdkDragContext *context,
                                                GtkSelectionData *data,
                                                guint info)
{
    ...
    if(info == TARGET_TEXT_URI_LIST && action == GDK_ACTION_COPY
        ...
        if(drop_icon) {
            ...
            /* if it's a volume, but we don't have |tinfo|, this just isn't
             * going to work */
            if(!tinfo && ESDESKTOP_IS_VOLUME_ICON(drop_icon)) {
                return 0;
            }
...
esdesktop_file_icon_manager_new(GFile *folder,
                                EsconfChannel *channel)
{
    EsdesktopFileIconManager *fmanager;
    ...
    fmanager = g_object_new(ESDESKTOP_TYPE_FILE_ICON_MANAGER,
                            "folder", folder,
                            NULL);
    fmanager->priv->channel = ESCONF_CHANNEL(g_object_ref(G_OBJECT(channel)));

    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_FILESYSTEM, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-filesystem");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_HOME, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-home");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_TRASH, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-trash");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_REMOVABLE, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-removable");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_NETWORK_REMOVABLE, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-network-volume");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_DEVICE_REMOVABLE, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-device-volume");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_UNKNWON_REMOVABLE, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-unknown-volume");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_THUMBNAILS, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-thumbnails");
    esconf_g_property_bind(channel, DESKTOP_ICONS_SHOW_HIDDEN_FILES, G_TYPE_BOOLEAN,
                           G_OBJECT(fmanager), "show-hidden-files");
    esconf_g_property_bind(channel, DESKTOP_MENU_MAX_TEMPLATE_FILES, G_TYPE_INT,
                           G_OBJECT(fmanager), "max-templates");

    return ESDESKTOP_ICON_VIEW_MANAGER(fmanager);
}

static void
esdesktop_file_icon_manager_set_show_removable_media(EsdesktopFileIconManager *manager,
                                                     EsdesktopFileIconManagerProp prop,
                                                     gboolean show)
{
    g_return_if_fail(ESDESKTOP_IS_FILE_ICON_MANAGER(manager));
    ...
    esdesktop_file_icon_manager_remove_removable_media(manager);

    /* Then re-add the icons the user wants */
    if(manager->priv->show_removable_media)
        esdesktop_file_icon_manager_load_removable_media(manager);
}


static void
esdesktop_file_icon_manager_requeue_thumbnails(gpointer key,
                                               gpointer value,
                                               gpointer data)
{
    EsdesktopFileIconManager *fmanager = ESDESKTOP_FILE_ICON_MANAGER(data);
    EsdesktopFileIcon *icon = ESDESKTOP_FILE_ICON(value);
...
static void
esdesktop_file_icon_manager_remove_thumbnails(gpointer key,
                                              gpointer value,
                                              gpointer data)
{
    EsdesktopRegularFileIcon *icon = ESDESKTOP_REGULAR_FILE_ICON(value);

    esdesktop_icon_delete_thumbnail(ESDESKTOP_ICON(icon));
}

static void
esdesktop_file_icon_manager_set_show_thumbnails(EsdesktopFileIconManager *manager,
                                                gboolean show_thumbnails)
{
    g_return_if_fail(ESDESKTOP_IS_FILE_ICON_MANAGER(manager));
    ...
    if(show_thumbnails) {
        /* We have to request to create the thumbnails everytime. */
         g_hash_table_foreach(manager->priv->icons,
                         esdesktop_file_icon_manager_requeue_thumbnails,
                         manager);
    } else {
         ...
         */
         g_hash_table_foreach(manager->priv->icons,
                         esdesktop_file_icon_manager_remove_thumbnails,
                         manager);
    }
}

static void
esdesktop_file_icon_manager_set_show_hidden_files(EsdesktopFileIconManager *manager,
                                                  gboolean show_hidden_files)
{
    g_return_if_fail(ESDESKTOP_IS_FILE_ICON_MANAGER(manager));
...
static void
esdesktop_file_icon_manager_set_show_special_file(EsdesktopFileIconManager *manager,
                                                  EsdesktopSpecialFileIconType type,
                                                  gboolean show_special_file)
{
    g_return_if_fail(ESDESKTOP_IS_FILE_ICON_MANAGER(manager));
    g_return_if_fail((int)type >= 0 && type <= ESDESKTOP_SPECIAL_FILE_ICON_TRASH);
    ...
    if(show_special_file) {
        ...
        esdesktop_file_icon_manager_add_special_file_icon(manager, type);
    } else {
        EsdesktopIcon *icon = g_hash_table_lookup(manager->priv->special_icons,
                                                  GINT_TO_POINTER(type));
        if(icon) {
            esdesktop_icon_view_remove_item(manager->priv->icon_view, icon);
...
static void
esdesktop_file_icon_manager_update_image(GtkWidget *widget,
                                         gchar *srcfile,
                                         gchar *thumbfile,
                                         EsdesktopFileIconManager *manager)
{
    GFile *file;
    EsdesktopIcon *icon;

    g_return_if_fail(srcfile && thumbfile);
    g_return_if_fail(ESDESKTOP_FILE_ICON_MANAGER(manager));
    ...
    if(icon)
    {
        ...
        esdesktop_icon_set_thumbnail_file(icon, g_object_ref(file));
    }
