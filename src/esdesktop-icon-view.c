...
#include "esdesktop-window-icon-manager.h"
...
typedef struct
{
    ...
    GdkRectangle area;
    guint source_id;
} EsdesktopIdleRepaintData;

struct _EsdesktopIconViewPrivate
{
    EsdesktopIconViewManager *manager;
    ...
    EsdesktopIcon *cursor;
    EsdesktopIcon *first_clicked_item;
    EsdesktopIcon *item_under_pointer;
    ...
    /* tooltip options - There's a style and an esconf property.
     * The order is esconf, style, with a fall back of DEFAULT_TOOLTIP_SIZE.
     * esdesktop_icon_view_get_tooltip_size will return the correct size. */
    gboolean show_tooltips;
    gint   tooltip_size_from_style;
    double tooltip_size_from_esconf;

    gboolean single_click;
    gint gravity;
};

static void expidus_icon_view_set_property(GObject *object,
                                        guint property_id,
                                        const GValue *value,
                                        GParamSpec *pspec);
static void expidus_icon_view_get_property(GObject *object,
                                        guint property_id,
                                        GValue *value,
                                        GParamSpec *pspec);

static gboolean esdesktop_icon_view_button_press(GtkWidget *widget,
                                                 GdkEventButton *evt,
                                                 gpointer user_data);
static gboolean esdesktop_icon_view_button_release(GtkWidget *widget,
                                                   GdkEventButton *evt,
                                                   gpointer user_data);
static gboolean esdesktop_icon_view_key_press(GtkWidget *widget,
                                              GdkEventKey *evt,
                                              gpointer user_data);
static gboolean esdesktop_icon_view_focus_in(GtkWidget *widget,
                                             GdkEventFocus *evt,
                                             gpointer user_data);
static gboolean esdesktop_icon_view_focus_out(GtkWidget *widget,
                                              GdkEventFocus *evt,
                                              gpointer user_data);
static gboolean esdesktop_icon_view_motion_notify(GtkWidget *widget,
                                                  GdkEventMotion *evt,
                                                  gpointer user_data);
static gboolean esdesktop_icon_view_leave_notify(GtkWidget *widget,
                                                 GdkEventCrossing *evt,
                                                 gpointer user_data);
static void esdesktop_icon_view_style_updated(GtkWidget *widget);
static void esdesktop_icon_view_realize(GtkWidget *widget);
static void esdesktop_icon_view_unrealize(GtkWidget *widget);
static gboolean esdesktop_icon_view_draw(GtkWidget *widget,
                                         cairo_t *cr);
static void esdesktop_icon_view_drag_begin(GtkWidget *widget,
                                           GdkDragContext *contest);
static gboolean esdesktop_icon_view_drag_motion(GtkWidget *widget,
                                                GdkDragContext *context,
                                                gint x,
                                                gint y,
                                                guint time_);
static void esdesktop_icon_view_drag_leave(GtkWidget *widget,
                                           GdkDragContext *context,
                                           guint time_);
static gboolean esdesktop_icon_view_drag_drop(GtkWidget *widget,
                                              GdkDragContext *context,
                                              gint x,
                                              gint y,
                                              guint time_);
static void esdesktop_icon_view_drag_data_get(GtkWidget *widget,
                                              GdkDragContext *context,
                                              GtkSelectionData *data,
                                              guint info,
                                              guint time_);
static void esdesktop_icon_view_drag_data_received(GtkWidget *widget,
                                                   GdkDragContext *context,
                                                   gint x,
                                                   gint y,
                                                   GtkSelectionData *data,
...
static void esdesktop_icon_view_finalize(GObject *obj);

static void esdesktop_icon_view_add_move_binding(GtkBindingSet *binding_set,
                                                 guint keyval,
                                                 guint modmask,
                                                 GtkMovementStep step,
                                                 gint count);

static gboolean esdesktop_icon_view_update_icon_extents(EsdesktopIconView *icon_view,
                                                        EsdesktopIcon *icon,
                                                        GdkRectangle *pixbuf_extents,
                                                        GdkRectangle *text_extents,
                                                        GdkRectangle *box_extents,
                                                        GdkRectangle *total_extents);
static void esdesktop_icon_view_invalidate_icon(EsdesktopIconView *icon_view,
                                                EsdesktopIcon *icon,
                                                gboolean recalc_extents);
static void esdesktop_icon_view_icon_changed(EsdesktopIcon *icon,
                                             gpointer user_data);

static void esdesktop_icon_view_invalidate_icon_pixbuf(EsdesktopIconView *icon_view,
                                                       EsdesktopIcon *icon);

static void esdesktop_icon_view_paint_icon(EsdesktopIconView *icon_view,
                                           EsdesktopIcon *icon,
                                           GdkRectangle *area,
                                           cairo_t *cr);
static void esdesktop_icon_view_repaint_icons(EsdesktopIconView *icon_view,
                                              GdkRectangle *area,
                                              cairo_t *cr);

static void esdesktop_setup_grids(EsdesktopIconView *icon_view);
static gboolean esdesktop_grid_get_next_free_position(EsdesktopIconView *icon_view,
                                                      gint16 *row,
                                                      gint16 *col);
static inline gboolean esdesktop_grid_is_free_position(EsdesktopIconView *icon_view,
                                                       gint16 row,
                                                       gint16 col);
static inline void esdesktop_grid_set_position_free(EsdesktopIconView *icon_view,
                                                    gint16 row,
                                                    gint16 col);
static inline gboolean esdesktop_grid_unset_position_free_raw(EsdesktopIconView *icon_view,
                                                              gint16 row,
                                                              gint16 col,
                                                              gpointer data);
static inline gboolean esdesktop_grid_unset_position_free(EsdesktopIconView *icon_view,
                                                          EsdesktopIcon *icon);
static inline EsdesktopIcon *esdesktop_icon_view_icon_in_cell_raw(EsdesktopIconView *icon_view,
                                                                  gint idx);
static inline EsdesktopIcon *esdesktop_icon_view_icon_in_cell(EsdesktopIconView *icon_view,
                                                              gint16 row,
                                                              gint16 col);
static gint esdesktop_check_icon_clicked(gconstpointer data,
                                         gconstpointer user_data);
static void esdesktop_list_foreach_invalidate(gpointer data,
                                              gpointer user_data);

static inline void esdesktop_xy_to_rowcol(EsdesktopIconView *icon_view,
                                          gint x,
                                          gint y,
                                          gint16 *row,
                                          gint16 *col);
static gboolean esdesktop_grid_resize_timeout(gpointer user_data);
static void esdesktop_monitors_changed_cb(GdkScreen *gscreen,
                                          gpointer user_data);
static void esdesktop_screen_size_changed_cb(GdkScreen *gscreen,
                                            gpointer user_data);
static GdkFilterReturn esdesktop_rootwin_watch_workarea(GdkXEvent *gxevent,
                                                        GdkEvent *event,
                                                        gpointer user_data);
static void esdesktop_move_all_icons_to_pending_icons_list(EsdesktopIconView *icon_view);
static void esdesktop_move_all_pending_icons_to_desktop(EsdesktopIconView* icon_view);
static void esdesktop_grid_do_resize(EsdesktopIconView *icon_view);
static inline gboolean esdesktop_rectangle_contains_point(GdkRectangle *rect,
                                                          gint x,
                                                          gint y);
static void esdesktop_icon_view_modify_font_size(EsdesktopIconView *icon_view,
                                                 gdouble size);
static void esdesktop_icon_view_add_item_internal(EsdesktopIconView *icon_view,
                                                  EsdesktopIcon *icon);
static gboolean esdesktop_icon_view_icon_find_position(EsdesktopIconView *icon_view,
                                                       EsdesktopIcon *icon);
static gboolean esdesktop_icon_view_shift_area_to_cell(EsdesktopIconView *icon_view,
                                                       EsdesktopIcon *icon,
                                                       GdkRectangle *text_area);
static gint esdesktop_icon_view_get_tooltip_size(EsdesktopIconView *icon_view);
static gboolean esdesktop_icon_view_show_tooltip(GtkWidget *widget,
                                                 gint x,
                                                 gint y,
...
static gboolean esdesktop_icon_view_is_icon_selected(EsdesktopIconView *icon_view,
                                                     EsdesktopIcon *icon);
static void esdesktop_icon_view_real_select_all(EsdesktopIconView *icon_view);
static void esdesktop_icon_view_real_unselect_all(EsdesktopIconView *icon_view);
static void esdesktop_icon_view_real_select_cursor_item(EsdesktopIconView *icon_view);
static void esdesktop_icon_view_real_toggle_cursor_item(EsdesktopIconView *icon_view);
static gboolean esdesktop_icon_view_real_activate_selected_items(EsdesktopIconView *icon_view);
static gboolean esdesktop_icon_view_real_move_cursor(EsdesktopIconView *icon_view,
                                                     GtkMovementStep step,
                                                     gint count);

static void esdesktop_icon_view_move_cursor_left_right(EsdesktopIconView *icon_view,
                                                       gint count,
                                                       GdkModifierType modmask);
static void esdesktop_icon_view_select_between(EsdesktopIconView *icon_view,
                                               EsdesktopIcon *start_icon,
                                               EsdesktopIcon *end_icon);

enum
{
    TARGET_ESDESKTOP_ICON = 9999,
};
...
static const GtkTargetEntry icon_view_targets[] = {
    { "ESDESKTOP_ICON", GTK_TARGET_SAME_APP, TARGET_ESDESKTOP_ICON }
};
...
G_DEFINE_TYPE_WITH_PRIVATE(EsdesktopIconView, esdesktop_icon_view, GTK_TYPE_WIDGET)


static void
esdesktop_icon_view_class_init(EsdesktopIconViewClass *klass)
{
    ...
    gobject_class->finalize = esdesktop_icon_view_finalize;
    gobject_class->set_property = expidus_icon_view_set_property;
    gobject_class->get_property = expidus_icon_view_get_property;

    widget_class->style_updated = esdesktop_icon_view_style_updated;
    widget_class->realize = esdesktop_icon_view_realize;
    widget_class->unrealize = esdesktop_icon_view_unrealize;
    widget_class->draw = esdesktop_icon_view_draw;
    widget_class->drag_begin = esdesktop_icon_view_drag_begin;
    widget_class->drag_motion = esdesktop_icon_view_drag_motion;
    widget_class->drag_leave = esdesktop_icon_view_drag_leave;
    widget_class->drag_drop = esdesktop_icon_view_drag_drop;
    widget_class->drag_data_get = esdesktop_icon_view_drag_data_get;
    widget_class->drag_data_received = esdesktop_icon_view_drag_data_received;

    klass->select_all = esdesktop_icon_view_real_select_all;
    klass->unselect_all = esdesktop_icon_view_real_unselect_all;
    klass->select_cursor_item = esdesktop_icon_view_real_select_cursor_item;
    klass->toggle_cursor_item = esdesktop_icon_view_real_toggle_cursor_item;
    klass->activate_selected_items = esdesktop_icon_view_real_activate_selected_items;
    klass->move_cursor = esdesktop_icon_view_real_move_cursor;

    __signals[SIG_ICON_SELECTION_CHANGED] = g_signal_new("icon-selection-changed",
                                                         ESDESKTOP_TYPE_ICON_VIEW,
                                                         G_SIGNAL_RUN_LAST,
                                                         G_STRUCT_OFFSET(EsdesktopIconViewClass,
    ...
    __signals[SIG_MOVE_CURSOR] = g_signal_new(I_("move-cursor"),
                                              ...
                                              G_STRUCT_OFFSET(EsdesktopIconViewClass,
                                                              move_cursor),
                                              NULL, NULL,
                                              esdesktop_marshal_BOOLEAN__ENUM_INT,
                                              G_TYPE_BOOLEAN, 2,
...
#undef ESDESKTOP_PARAM_FLAGS
    ...
    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_Up, 0,
                                         GTK_MOVEMENT_DISPLAY_LINES, -1);
    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_KP_Up, 0,
                                         GTK_MOVEMENT_DISPLAY_LINES, -1);

    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_Down, 0,
                                         GTK_MOVEMENT_DISPLAY_LINES, 1);
    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_KP_Down, 0,
                                         GTK_MOVEMENT_DISPLAY_LINES, 1);

    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_p, GDK_CONTROL_MASK,
                                         GTK_MOVEMENT_DISPLAY_LINES, -1);

    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_n, GDK_CONTROL_MASK,
                                         GTK_MOVEMENT_DISPLAY_LINES, 1);

    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_Home, 0,
                                         GTK_MOVEMENT_BUFFER_ENDS, -1);
    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_KP_Home, 0,
                                         GTK_MOVEMENT_BUFFER_ENDS, -1);

    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_End, 0,
                                         GTK_MOVEMENT_BUFFER_ENDS, 1);
    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_KP_End, 0,
                                         GTK_MOVEMENT_BUFFER_ENDS, 1);

    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_Right, 0,
                                         GTK_MOVEMENT_VISUAL_POSITIONS, 1);
    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_Left, 0,
                                         GTK_MOVEMENT_VISUAL_POSITIONS, -1);

    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_KP_Right, 0,
                                         GTK_MOVEMENT_VISUAL_POSITIONS, 1);
    esdesktop_icon_view_add_move_binding(binding_set, GDK_KEY_KP_Left, 0,
                                         GTK_MOVEMENT_VISUAL_POSITIONS, -1);

    gtk_widget_class_set_css_name (widget_class, "EsdesktopIconView");
}

static void
esdesktop_icon_view_init(EsdesktopIconView *icon_view)
{
    GtkStyleContext *context;

    icon_view->priv = esdesktop_icon_view_get_instance_private(icon_view);
    ...
    g_signal_connect(G_OBJECT(icon_view), "query-tooltip",
                     G_CALLBACK(esdesktop_icon_view_show_tooltip), NULL);
...
static void
esdesktop_icon_view_finalize(GObject *obj)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(obj);

    if(icon_view->priv->manager) {
        esdesktop_icon_view_manager_fini(icon_view->priv->manager);
    ...
    G_OBJECT_CLASS(esdesktop_icon_view_parent_class)->finalize(obj);
}

static void
expidus_icon_view_set_property(GObject *object,
                            guint property_id,
                            const GValue *value,
                            GParamSpec *pspec)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(object);
    ...
    switch(property_id) {
        ...
        case PROP_TOOLTIP_SIZE:
            icon_view->priv->tooltip_size_from_esconf = g_value_get_double(value);
            break;
...
static void
expidus_icon_view_get_property(GObject *object,
                           guint property_id,
                           GValue *value,
                           GParamSpec *pspec)
{
    ...
    switch(property_id) {
        ...
        case PROP_TOOLTIP_SIZE:
            g_value_set_double(value, icon_view->priv->tooltip_size_from_esconf);
            break;
...
static void
esdesktop_icon_view_add_move_binding(GtkBindingSet *binding_set,
                                     guint keyval,
                                     guint modmask,
                                     GtkMovementStep step,
                                     gint count)
...
static gboolean
esdesktop_icon_view_get_single_click(EsdesktopIconView *icon_view)
{
    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view), FALSE);

    return icon_view->priv->single_click;
}

static void
esdesktop_icon_view_clear_drag_event(EsdesktopIconView *icon_view, GtkWidget *widget)
{
    DBG("unsetting stuff");
...
static gboolean
esdesktop_icon_view_button_press(GtkWidget *widget,
                                 GdkEventButton *evt,
                                 gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
    EsdesktopIcon *icon;
    ...
    if(evt->type == GDK_BUTTON_PRESS) {
        ...
        if(evt->button == 2 || evt->button == 3)
            esdesktop_icon_view_clear_drag_event(icon_view, widget);

        /* Let expidus-desktop handle button 2 */
        if(evt->button == 2) {
        ...
        icon_l = g_list_find_custom(icon_view->priv->icons, evt,
                                    (GCompareFunc)esdesktop_check_icon_clicked);
        if(icon_l && (icon = icon_l->data)) {
            if(esdesktop_icon_view_is_icon_selected(icon_view, icon)) {
                   ...
                   || !(evt->state & GDK_CONTROL_MASK))
                {
                    ...
                    esdesktop_icon_view_unselect_all(icon_view);
                ...
                if(icon_view->priv->sel_mode == GTK_SELECTION_MULTIPLE
                   ...
                   && icon_view->priv->first_clicked_item != icon)
                {
                    esdesktop_icon_view_select_between(icon_view,
                                                       icon_view->priv->first_clicked_item,
                                                       icon);
                } else
                    esdesktop_icon_view_select_item(icon_view, icon);
            }
            ...
            if(evt->button == 3 || (evt->button == 1 && (evt->state & GDK_SHIFT_MASK))) {
                expidus_desktop_popup_root_menu(EXPIDUS_DESKTOP(widget), evt->button, evt->time);
                return TRUE;
            }
        }
    } else if(evt->type == GDK_2BUTTON_PRESS) {
        /* filter this event in single click mode */
        if(esdesktop_icon_view_get_single_click(icon_view)) {
...
static gint
esdesktop_icon_view_get_tooltip_size(EsdesktopIconView *icon_view)
{
    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view), DEFAULT_TOOLTIP_SIZE);

    /* Check if we're showing tooltips at all */
    if(!icon_view->priv->show_tooltips)
        return 0;

    /* If the esconf size is set and sane, use it */
    if(icon_view->priv->tooltip_size_from_esconf >= 0)
        return icon_view->priv->tooltip_size_from_esconf;
...
static gboolean
esdesktop_icon_view_button_release(GtkWidget *widget,
                                   GdkEventButton *evt,
                                   gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
       ...
       icon_view->priv->maybe_begin_drag == TRUE)
    {
        ...
        if(icon_l && (icon = icon_l->data)) {
            expidus_desktop_popup_root_menu(EXPIDUS_DESKTOP(widget), 0, evt->time);
        }
    }
       ...
       && icon_view->priv->control_click)
    {
        ...
        if(icon_l && (icon = icon_l->data)) {
            if(esdesktop_icon_view_is_icon_selected(icon_view, icon)) {
                ...
                /* unselect */
                esdesktop_icon_view_unselect_item(icon_view, icon);
            }
        }
    }
...
static gboolean
esdesktop_icon_view_select_icon_from_list_by_key(EsdesktopIconView *icon_view,
                                                 GdkEventKey *evt,
                                                 GList *icon_list)
{
    EsdesktopIcon *icon = NULL;
    const gchar *label;
    ...
    for(l = icon_list; l; l = l->next) {
        icon = (EsdesktopIcon *)l->data;
        label = esdesktop_icon_peek_label(icon);
...
static void
esdesktop_icon_view_type_ahead_find_icon(EsdesktopIconView *icon_view,
                                         GdkEventKey *evt)
{
    ...
    icon_selected = esdesktop_icon_view_select_icon_from_list_by_key(icon_view, evt,
    ...
    if(icon_selected == FALSE) {
        esdesktop_icon_view_select_icon_from_list_by_key(icon_view,
                                                         evt,
...
static gboolean
esdesktop_icon_view_key_press(GtkWidget *widget,
                              GdkEventKey *evt,
                              gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
    ...
    if(ret == FALSE) {
        ...
        if((evt->state & ignore_modifiers) == 0) {
            ...
            if(unicode && g_unichar_isgraph(unicode) == TRUE)
                esdesktop_icon_view_type_ahead_find_icon(icon_view, evt);
        }
    }
...
static gboolean
esdesktop_icon_view_focus_in(GtkWidget *widget,
                             GdkEventFocus *evt,
                             gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
    ...
    for(l = icon_view->priv->selected_icons; l; l = l->next) {
        esdesktop_icon_view_invalidate_icon(icon_view, l->data, FALSE);
    }
...
static gboolean
esdesktop_icon_view_focus_out(GtkWidget *widget,
                              GdkEventFocus *evt,
                              gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
...
static gboolean
esdesktop_icon_view_maybe_begin_drag(EsdesktopIconView *icon_view,
                                     GdkEventMotion *evt)
{
...
static gboolean
esdesktop_icon_view_show_tooltip(GtkWidget *widget,
                                 gint x,
                                 gint y,
                                 gboolean keyboard_tooltip,
                                 GtkTooltip *tooltip,
                                 gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(widget);
    ...
    tooltip_size = esdesktop_icon_view_get_tooltip_size(icon_view);

    tip_text = esdesktop_icon_peek_tooltip(icon_view->priv->item_under_pointer);
    if(!tip_text)
        return FALSE;
    ...
    if(tooltip_size > 0) {
        gtk_tooltip_set_icon(tooltip,
                esdesktop_icon_peek_tooltip_pixbuf(icon_view->priv->item_under_pointer,
                                                   tooltip_size * 1.5f,
                                                   tooltip_size));
    }
...
static gboolean
esdesktop_icon_view_motion_notify(GtkWidget *widget,
                                  GdkEventMotion *evt,
                                  gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
       ...
       && !icon_view->priv->definitely_dragging)
    {
        ...
        icon_view->priv->definitely_dragging = esdesktop_icon_view_maybe_begin_drag(icon_view,
                                                                                    evt);
                  ...
                  || icon_view->priv->definitely_rubber_banding))
    {
           ...
           || old_rect.height > new_rect->height)
        {
            ...
            while(l) {
                ...
                if(esdesktop_icon_get_extents(icon, NULL, NULL, &extents)
           ...
           || old_rect.height < new_rect->height)
        {
            for(l = icon_view->priv->icons; l; l = l->next) {
                ...
                if(esdesktop_icon_get_extents(icon, NULL, NULL, &extents)
                   && gdk_rectangle_intersect(&extents, new_rect, &dummy)
                   && !esdesktop_icon_view_is_icon_selected(icon_view, icon))
                {
        ...
        if(icon_view->priv->item_under_pointer) {
            ...
            if(!esdesktop_icon_get_extents(icon_view->priv->item_under_pointer,
                                           NULL, NULL, &extents)
               || !esdesktop_rectangle_contains_point(&extents, evt->x, evt->y))
            {
                icon = icon_view->priv->item_under_pointer;
                icon_view->priv->item_under_pointer = NULL;

                esdesktop_icon_view_invalidate_icon_pixbuf(icon_view, icon);
            }
        } else {
            if(G_UNLIKELY(icon_view->priv->single_click)) {
                gdk_window_set_cursor(evt->window, NULL);
            }
            icon = esdesktop_icon_view_widget_coords_to_item(icon_view,
                                                             evt->x,
                                                             evt->y);
            if(icon && esdesktop_icon_get_extents(icon, NULL, NULL, &extents)
               && esdesktop_rectangle_contains_point(&extents, evt->x, evt->y))
            {
...
static gboolean
esdesktop_icon_view_leave_notify(GtkWidget *widget,
                                 GdkEventCrossing *evt,
                                 gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
    ...
    if(icon_view->priv->item_under_pointer) {
        EsdesktopIcon *icon = icon_view->priv->item_under_pointer;
        icon_view->priv->item_under_pointer = NULL;

        esdesktop_icon_view_invalidate_icon(icon_view, icon, FALSE);
    }
...
static void
esdesktop_icon_view_drag_begin(GtkWidget *widget,
                               GdkDragContext *context)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(widget);
    EsdesktopIcon *icon;
    ...
    if(esdesktop_icon_get_extents(icon, NULL, NULL, &extents)) {
        ...
        pix = esdesktop_icon_peek_pixbuf(icon, ICON_WIDTH, ICON_SIZE);
        if(pix)
...
static inline void
esdesktop_xy_to_rowcol(EsdesktopIconView *icon_view,
                       gint x,
                       gint y,
                       gint16 *row,
                       gint16 *col)
...
static inline void
esdesktop_icon_view_clear_drag_highlight(EsdesktopIconView *icon_view)
{
    EsdesktopIcon *icon;
...
static inline void
esdesktop_icon_view_draw_drag_highlight(EsdesktopIconView *icon_view,
                                        guint16 row,
                                        guint16 col)
{
    EsdesktopIcon *icon;

    icon = esdesktop_icon_view_icon_in_cell(icon_view, row, col);

    if(!icon && icon_view->priv->item_under_pointer) {
        /* clear previous highlight */
        esdesktop_icon_view_clear_drag_highlight(icon_view);
    }
...
static gboolean
esdesktop_icon_view_drag_motion(GtkWidget *widget,
                                GdkDragContext *context,
                                gint x,
                                gint y,
                                guint time_)
{
    ...
    EsdesktopIcon *icon_on_dest = NULL;
    ...
    /* can we drop here? */
    esdesktop_xy_to_rowcol(icon_view, x, y, &hover_row, &hover_col);
    if(hover_row >= icon_view->priv->nrows || hover_col >= icon_view->priv->ncols)
        return FALSE;
    icon_on_dest = esdesktop_icon_view_icon_in_cell(icon_view, hover_row,
                                                    hover_col);
    if(icon_on_dest) {
        if(!esdesktop_icon_get_allowed_drop_actions(icon_on_dest, NULL))
            return FALSE;
    } else if(!esdesktop_grid_is_free_position(icon_view, hover_row, hover_col))
        return FALSE;

    is_local_drag = (target == gdk_atom_intern("ESDESKTOP_ICON", FALSE));
    ...
    if(!icon_on_dest) {
        ...
        if(is_local_drag) {  /* #2 */
            ...
            for(l = icon_view->priv->selected_icons; l; l = l->next) {
                EsdesktopIcon *sel_icon = l->data;
                if(esdesktop_icon_get_position(sel_icon, &sel_row, &sel_col)
            ...
            allowed_actions &= esdesktop_icon_get_allowed_drag_actions(icon_view->priv->cursor);

            /* for local drags, let the dest icon decide */
            allowed_actions &= esdesktop_icon_get_allowed_drop_actions(icon_on_dest, &our_action);
            ...
            allowed_actions &= esdesktop_icon_get_allowed_drop_actions(icon_on_dest, NULL);
    ...
    g_object_set_data(G_OBJECT(context), "--esdesktop-icon-view-drop-icon",
                      icon_on_dest);
    gtk_drag_get_data(widget, context, target, time_);

    /* the actual call to gdk_drag_status() is deferred to
     * esdesktop_icon_view_drag_data_received() */

    return TRUE;
}

static void
esdesktop_icon_view_drag_leave(GtkWidget *widget,
                               GdkDragContext *context,
                               guint time_)
{
    esdesktop_icon_view_clear_drag_highlight(ESDESKTOP_ICON_VIEW(widget));
}

static void
esdesktop_next_slot(EsdesktopIconView *icon_view,
                    gint16 *col,
                    gint16 *row,
                    gint16 ncols,
                    gint16 nrows)
...
static gboolean
esdesktop_icon_view_drag_drop(GtkWidget *widget,
                              GdkDragContext *context,
                              gint x,
                              gint y,
                              guint time_)
{
    ...
    esdesktop_xy_to_rowcol(icon_view, x, y, &row, &col);
    icon_on_dest = esdesktop_icon_view_icon_in_cell(icon_view, row, col);

    if(target == gdk_atom_intern("ESDESKTOP_ICON", FALSE)) {
        if(icon_on_dest) {
            ...
            if(action == GDK_ACTION_ASK) {
                esdesktop_dnd_menu(icon_view->priv->manager, icon_on_dest,
            ...
            for(l = icon_view->priv->selected_icons; l; l = l->next) {
                if(esdesktop_icon_do_drop_dest(icon_on_dest,
                                               ESDESKTOP_ICON(l->data),
                                               action))
                {
                    ret = TRUE;
                }
        ...
        if(esdesktop_icon_get_position(icon, &old_row, &old_col)) {
        ...
        for(l = icon_view->priv->selected_icons; l; l = l->next) {
            ...
            esdesktop_icon_view_invalidate_icon(icon_view, l->data, FALSE);
            if(esdesktop_icon_get_position(l->data, &old_row, &old_col))
                esdesktop_grid_set_position_free(icon_view, old_row, old_col);
        }
        ...
        for(l = icon_view->priv->selected_icons; l; l = l->next) {
            ...
            while(!esdesktop_grid_is_free_position(icon_view, row, col)) {
                esdesktop_next_slot(icon_view, &col, &row, icon_view->priv->ncols, icon_view->priv->nrows);
            }

            /* set new position */
            esdesktop_icon_set_position(l->data, row, col);
            esdesktop_grid_unset_position_free(icon_view, l->data);

            /* clear out old extents, if any */
            esdesktop_icon_view_invalidate_icon(icon_view, l->data, TRUE);
        }
        ...
        g_object_set_data(G_OBJECT(context), "--esdesktop-icon-view-drop-icon",
                          icon_on_dest);
        return esdesktop_icon_view_manager_drag_drop(icon_view->priv->manager,
                                                     icon_on_dest,
                                                     context,
                                                     row, col, time_);
    }
...
static void
esdesktop_icon_view_drag_data_get(GtkWidget *widget,
                                  GdkDragContext *context,
                                  GtkSelectionData *data,
                                  guint info,
                                  guint time_)
{
    ...
    if(ESDESKTOP_IS_WINDOW_ICON_MANAGER(icon_view->priv->manager))
        return;
    ...
    esdesktop_icon_view_manager_drag_data_get(icon_view->priv->manager,
...
static void
esdesktop_icon_view_drag_data_received(GtkWidget *widget,
                                       GdkDragContext *context,
                                       gint x,
                                       gint y,
                                       GtkSelectionData *data,
                                       ...
                                       guint time_)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(widget);
    gint16 row, col;
    EsdesktopIcon *icon_on_dest;

    DBG("entering");

    icon_on_dest = g_object_get_data(G_OBJECT(context),
                                     "--esdesktop-icon-view-drop-icon");
    ...
    if(icon_view->priv->dropped) {
        ...
        esdesktop_icon_view_manager_drag_data_received(icon_view->priv->manager,
                                                       icon_on_dest,
        ...
        if(!ESDESKTOP_IS_WINDOW_ICON_MANAGER(icon_view->priv->manager)) {
            action = esdesktop_icon_view_manager_propose_drop_action(icon_view->priv->manager,
                                                                     icon_on_dest,
                                                                     action,
                                                                     context, data,
                                                                     info);
        ...
        if(action == 0)
            ...
            esdesktop_icon_view_draw_drag_highlight(icon_view,
...
#ifdef ENABLE_FILE_ICONS
static gint
esdesktop_icon_view_compare_icons(gconstpointer *a,
                                  gconstpointer *b)
{
    EsdesktopIcon *a_icon, *b_icon;
    const gchar *a_str, *b_str;

    a_icon = ESDESKTOP_ICON(a);
    b_icon = ESDESKTOP_ICON(b);

    a_str = esdesktop_icon_peek_label(a_icon);
    b_str = esdesktop_icon_peek_label(b_icon);
...
#ifdef ENABLE_FILE_ICONS
static void
esdesktop_icon_view_append_icons(EsdesktopIconView *icon_view,
                                 GList *icon_list,
                                 gint16 *row,
                                 gint16 *col)
{
...
void
esdesktop_icon_view_sort_icons(EsdesktopIconView *icon_view)
{
#ifdef ENABLE_FILE_ICONS
    GList *l = NULL;
    guint i;
    ...
    for(l = icon_view->priv->icons; l; l = l->next) {
        ...
        if(ESDESKTOP_IS_SPECIAL_FILE_ICON(l->data)) {
            i = 0;
        } else if(ESDESKTOP_IS_VOLUME_ICON(l->data)) {
            i = 1;
        } else if(ESDESKTOP_IS_FILE_ICON(l->data) &&
                  g_file_query_file_type(esdesktop_file_icon_peek_file(l->data),
    ...
    for(i = 0; i < sizeof(icons) / sizeof(icons[0]); ++i) {
        l = g_list_sort(icons[i],
                        (GCompareFunc)esdesktop_icon_view_compare_icons);
        esdesktop_icon_view_append_icons(icon_view, l, &row, &col);
        g_list_free(l);
    }
#endif
}
...
static void
esdesktop_icon_view_icon_theme_changed(GtkIconTheme *icon_theme,
                                       gpointer user_data)
{
...
static void
esdesktop_icon_view_style_updated(GtkWidget *widget)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(widget);
    ...
    GTK_WIDGET_CLASS(esdesktop_icon_view_parent_class)->style_updated(widget);
}

static void
esdesktop_icon_view_realize(GtkWidget *widget)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(widget);
    PangoContext *pctx;
    GdkScreen *gscreen;
    ...
    esdesktop_icon_view_style_updated(widget);
    ...
    esdesktop_icon_view_manager_init(icon_view->priv->manager, icon_view);
    ...
    if(icon_view->priv->font_size > 0) {
        esdesktop_icon_view_modify_font_size(icon_view,
                                             icon_view->priv->font_size);
    }

    esdesktop_setup_grids(icon_view);
    ...
    g_signal_connect(G_OBJECT(icon_view->priv->parent_window),
                     "motion-notify-event",
                     G_CALLBACK(esdesktop_icon_view_motion_notify), icon_view);
    g_signal_connect(G_OBJECT(icon_view->priv->parent_window),
                     "leave-notify-event",
                     G_CALLBACK(esdesktop_icon_view_leave_notify), icon_view);
    g_signal_connect(G_OBJECT(icon_view->priv->parent_window),
                     "key-press-event",
                     G_CALLBACK(esdesktop_icon_view_key_press), icon_view);
    g_signal_connect(G_OBJECT(icon_view->priv->parent_window),
                     "button-press-event",
                     G_CALLBACK(esdesktop_icon_view_button_press), icon_view);
    g_signal_connect(G_OBJECT(icon_view->priv->parent_window),
                     "button-release-event",
                     G_CALLBACK(esdesktop_icon_view_button_release), icon_view);
    g_signal_connect(G_OBJECT(icon_view->priv->parent_window),
                     "focus-in-event",
                     G_CALLBACK(esdesktop_icon_view_focus_in), icon_view);
    g_signal_connect(G_OBJECT(icon_view->priv->parent_window),
                     "focus-out-event",
                     G_CALLBACK(esdesktop_icon_view_focus_out), icon_view);
    ...
    gdk_window_add_filter(groot, esdesktop_rootwin_watch_workarea, icon_view);

    g_signal_connect(G_OBJECT(gscreen), "monitors-changed",
                     G_CALLBACK(esdesktop_monitors_changed_cb), icon_view);
    g_signal_connect(G_OBJECT(gscreen), "size-changed",
                     G_CALLBACK(esdesktop_screen_size_changed_cb), icon_view);

    g_signal_connect_after(G_OBJECT(gtk_icon_theme_get_for_screen(gscreen)),
                           "changed",
                           G_CALLBACK(esdesktop_icon_view_icon_theme_changed),
                           icon_view);

    esdesktop_move_all_pending_icons_to_desktop(icon_view);
}

static void
esdesktop_icon_view_unrealize(GtkWidget *widget)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(widget);
    GdkScreen *gscreen;
    GdkWindow *groot;
    ...
    gscreen = gtk_widget_get_screen(widget);
    groot = gdk_screen_get_root_window(gscreen);
    gdk_window_remove_filter(groot, esdesktop_rootwin_watch_workarea, icon_view);
    ...
    g_signal_handlers_disconnect_by_func(G_OBJECT(gscreen),
                                         G_CALLBACK(esdesktop_screen_size_changed_cb),
                                         icon_view);
    ...
    esdesktop_move_all_icons_to_pending_icons_list(icon_view);
...
static gboolean
esdesktop_icon_view_draw(GtkWidget *widget,
                         cairo_t *cr)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(widget);
    ...
    esdesktop_icon_view_repaint_icons(icon_view, &clipbox, cr);
...
static void
esdesktop_icon_view_real_select_all(EsdesktopIconView *icon_view)
{
    DBG("entering");

    esdesktop_icon_view_select_all(icon_view);
}

static void
esdesktop_icon_view_real_unselect_all(EsdesktopIconView *icon_view)
{
    DBG("entering");
...
static void
esdesktop_icon_view_real_select_cursor_item(EsdesktopIconView *icon_view)
{
    DBG("entering");

    if(icon_view->priv->cursor)
        esdesktop_icon_view_select_item(icon_view, icon_view->priv->cursor);
}

static void
esdesktop_icon_view_real_toggle_cursor_item(EsdesktopIconView *icon_view)
{
    DBG("entering");
    ...
    if(g_list_find(icon_view->priv->selected_icons, icon_view->priv->cursor))
        esdesktop_icon_view_unselect_item(icon_view, icon_view->priv->cursor);
    else
        esdesktop_icon_view_select_item(icon_view, icon_view->priv->cursor);
}

static gboolean
esdesktop_icon_view_real_activate_selected_items(EsdesktopIconView *icon_view)
{
    DBG("entering");
    ...
    g_list_foreach(icon_view->priv->selected_icons, (GFunc)esdesktop_icon_activated, NULL);

    return TRUE;
}

static void
esdesktop_icon_view_select_between(EsdesktopIconView *icon_view,
                                   EsdesktopIcon *start_icon,
                                   EsdesktopIcon *end_icon)
{
    ...
    if(esdesktop_icon_get_position(start_icon, &start_row, &start_col)
       && esdesktop_icon_get_position(end_icon, &end_row, &end_col))
    {
        ...
        for(i = start_row; i <= end_row; ++i) {
            for(j = (i == start_row ? start_col : 0);
                ...
                ++j)
            {
                icon = esdesktop_icon_view_icon_in_cell(icon_view, i, j);
                if(icon) {
                    esdesktop_icon_view_select_item(icon_view, icon);
                }
            }
...
static EsdesktopIcon *
esdesktop_icon_view_find_first_icon(EsdesktopIconView *icon_view)
{
    gint i, j;
    EsdesktopIcon *icon = NULL;
...
static EsdesktopIcon *
esdesktop_icon_view_find_last_icon(EsdesktopIconView *icon_view)
{
    EsdesktopIcon *icon = NULL;
    gint i, j;
...
static void
esdesktop_icon_view_move_cursor_left_right(EsdesktopIconView *icon_view,
                                           gint count,
                                           GdkModifierType modmask)
{
    gint16 row, col;
    ...
    if(!icon_view->priv->cursor) {
        ...
        if(count < 0)
            icon = esdesktop_icon_view_find_last_icon(icon_view);
        else
            icon = esdesktop_icon_view_find_first_icon(icon_view);
        ...
        if(!esdesktop_icon_get_position(icon_view->priv->cursor, &row, &col))
            return;
...
static void
esdesktop_icon_view_move_cursor_up_down(EsdesktopIconView *icon_view,
                                        gint count,
                                        GdkModifierType modmask)
{
    gint16 row, col;
...
static void
esdesktop_icon_view_move_cursor_begin_end(EsdesktopIconView *icon_view,
                                          gint count,
                                          GdkModifierType modmask)
{
    EsdesktopIcon *icon = NULL, *old_cursor;
    ...
    if(!old_cursor || !(modmask & (GDK_SHIFT_MASK|GDK_CONTROL_MASK))) {
        ...
        if(modmask & GDK_SHIFT_MASK) {
            ...
            esdesktop_icon_view_select_between(icon_view, old_cursor, icon);
...
static gboolean
esdesktop_icon_view_real_move_cursor(EsdesktopIconView *icon_view,
                                     GtkMovementStep step,
                                     gint count)
{
    ...
    switch(step) {
        case GTK_MOVEMENT_VISUAL_POSITIONS:
            esdesktop_icon_view_move_cursor_left_right(icon_view, count, modmask);
            break;

        case GTK_MOVEMENT_DISPLAY_LINES:
            esdesktop_icon_view_move_cursor_up_down(icon_view, count, modmask);
            break;

        case GTK_MOVEMENT_BUFFER_ENDS:
            esdesktop_icon_view_move_cursor_begin_end(icon_view, count, modmask);
            break;
...
static void
esdesktop_monitors_changed_cb(GdkScreen *gscreen,
                              gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);

    /* Resize the grid to be sure we take into account monitor setup changes */
    esdesktop_grid_do_resize(icon_view);
}


static void
esdesktop_screen_size_changed_cb(GdkScreen *gscreen,
                                 gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
   ...
   /* this is kinda icky.  we want to use _NET_WORKAREA to reset the size of
    ...
    icon_view->priv->grid_resize_timeout = g_timeout_add(7000,
                                                         esdesktop_grid_resize_timeout,
                                                         icon_view);
}

static void
esdesktop_icon_view_repaint_icons(EsdesktopIconView *icon_view,
                                  GdkRectangle *area,
                                  cairo_t *cr)
{
    GdkRectangle extents, dummy;
    ...
    for(l = icon_view->priv->icons; l; l = l->next) {
        ...
        {
            esdesktop_icon_view_paint_icon(icon_view, icon, area, cr);
        }
    }
...
esdesktop_rectangle_equal(GdkRectangle *rect1, GdkRectangle *rect2)
{
...
static inline gboolean
esdesktop_rectangle_is_bounded_by(GdkRectangle *rect,
                                  GdkRectangle *bounds)
{
    GdkRectangle intersection;

    if(gdk_rectangle_intersect(rect, bounds, &intersection)) {
        if(esdesktop_rectangle_equal(rect, &intersection))
            return TRUE;
    }
...
static void
esdesktop_icon_view_setup_grids_xinerama(EsdesktopIconView *icon_view)
{
    GdkDisplay *display;
    ...
    for(row = 0; row < icon_view->priv->nrows; ++row) {
        for(col = 0; col < icon_view->priv->ncols; ++col) {
            ...
            for(i = 0; i < nmonitors; ++i) {
                if(esdesktop_rectangle_is_bounded_by(&cell_rect,
                                                     &monitor_geoms[i]))
                {
                    bounded = TRUE;
                    break;
            ...
            if(!bounded) {
                esdesktop_grid_unset_position_free_raw(icon_view, row, col,
                                                       (gpointer)0xdeadbeef);
            }
        }
    }
...
static void
esdesktop_setup_grids(EsdesktopIconView *icon_view)
{
    ...
    else if (!esdesktop_get_workarea_single(icon_view, 0,
                                            &xorigin, &yorigin,
                                            &width, &height)) {
        monitor = gdk_display_get_monitor_at_window (display, gtk_widget_get_parent_window(GTK_WIDGET(icon_view)));
        esdesktop_get_screen_dimensions (screen, &width, &height);
        xorigin = yorigin = 0;
    }
    ...
    esdesktop_icon_view_setup_grids_xinerama(icon_view);
}

static GdkFilterReturn
esdesktop_rootwin_watch_workarea(GdkXEvent *gxevent,
                                 GdkEvent *event,
                                 gpointer user_data)
{
    EsdesktopIconView *icon_view = user_data;
...
static void
esdesktop_icon_view_invalidate_icon(EsdesktopIconView *icon_view,
                                    EsdesktopIcon *icon,
                                    gboolean recalc_extents)
{
    ...
    if(recalc_extents) {
        ...
        if(!esdesktop_icon_view_update_icon_extents(icon_view, icon,
                                                    &pixbuf_extents,
                                                    &text_extents,
                                                    &box_extents,
                                                    &total_extents))
    ...
    if(!invalidated_something) {
        DBG("Icon '%s' doesn't have extents: need to call paint some other way",
            esdesktop_icon_peek_label(icon));
    }
}

static void
esdesktop_icon_view_invalidate_icon_pixbuf(EsdesktopIconView *icon_view,
                                           EsdesktopIcon *icon)
{
    GdkPixbuf *pix;
    ...
    if(pix) {
        ...
        if(!esdesktop_icon_view_shift_area_to_cell(icon_view, icon, &rect))
            return;
...
static gboolean
esdesktop_icon_view_calculate_icon_pixbuf_area(EsdesktopIconView *icon_view,
                                               EsdesktopIcon *icon,
                                               GdkRectangle *pixbuf_area)
{
    GdkPixbuf *pix;

    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view)
                         && ESDESKTOP_IS_ICON(icon)
                         && pixbuf_area, FALSE);
...
static void
esdesktop_icon_view_setup_pango_layout(EsdesktopIconView *icon_view,
                                       EsdesktopIcon *icon,
                                       PangoLayout *playout)
{
    ...
    PangoAttribute *attr;
#endif
    const gchar *label = esdesktop_icon_peek_label(icon);

    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view)
                     && ESDESKTOP_IS_ICON(icon));
...
static gboolean
esdesktop_icon_view_calculate_icon_text_area(EsdesktopIconView *icon_view,
                                             EsdesktopIcon *icon,
                                             GdkRectangle *text_area)
{
    PangoLayout *playout;
    ...
    esdesktop_icon_view_setup_pango_layout(icon_view, icon, playout);
...
static gboolean
esdesktop_icon_view_shift_area_to_cell(EsdesktopIconView *icon_view,
                                       EsdesktopIcon *icon,
                                       GdkRectangle *area)
{
    gint16 row, col;
...
static gboolean
esdesktop_icon_view_update_icon_extents(EsdesktopIconView *icon_view,
                                        EsdesktopIcon *icon,
                                        GdkRectangle *pixbuf_extents,
                                        GdkRectangle *text_extents,
                                        GdkRectangle *box_extents,
                                        GdkRectangle *total_extents)
{
    ...
    if(!esdesktop_icon_view_calculate_icon_pixbuf_area(icon_view, icon,
                                                       pixbuf_extents)
       || !esdesktop_icon_view_shift_area_to_cell(icon_view, icon,
                                                  pixbuf_extents))
    {
        return FALSE;
    }
    ...
    if(!esdesktop_icon_view_calculate_icon_text_area(icon_view, icon, text_extents))
        return FALSE;
    ...
    if(!esdesktop_icon_view_shift_area_to_cell(icon_view, icon, text_extents))
        return FALSE;
    ...
    *box_extents = *text_extents;
    ...
    esdesktop_icon_set_extents(icon, pixbuf_extents, text_extents, total_extents);

    return TRUE;
}

static void
esdesktop_icon_view_draw_image(cairo_t *cr, GdkPixbuf *pix, GdkRectangle *rect)
{
    cairo_save(cr);
...
static void
esdesktop_icon_view_draw_text(GtkWidget *icon_view, cairo_t *cr,
...
static void
esdesktop_icon_view_paint_icon(EsdesktopIconView *icon_view,
                               EsdesktopIcon *icon,
                               GdkRectangle *area,
                               cairo_t *cr)
{
    ...
    DBG("entering, (%s)(area=%dx%d+%d+%d)", esdesktop_icon_peek_label(icon),
    ...
    if(!esdesktop_icon_get_extents(icon, &pixbuf_extents,
                                   &text_extents, &total_extents))
    {
        g_warning("Can't get extents for icon '%s'", esdesktop_icon_peek_label(icon));
    }
    ...
    if(gdk_rectangle_intersect(area, &pixbuf_extents, &intersection)) {
        GdkPixbuf *pix = esdesktop_icon_peek_pixbuf(icon, ICON_WIDTH, ICON_SIZE);
        ...
        if(state != GTK_STATE_FLAG_NORMAL) {
            ...
            pix_free = endo_gdk_pixbuf_colorize(pix, &color);
            pix = pix_free;
        }

        if(icon_view->priv->item_under_pointer == icon) {
            GdkPixbuf *tmp = endo_gdk_pixbuf_spotlight(pix);
            if(pix_free)
        ...
        esdesktop_icon_view_draw_image(cr, pix, &pixbuf_extents);
       ...
       && icon_view->priv->font_size > 0)
    {
        ...
        esdesktop_icon_view_draw_text(GTK_WIDGET(icon_view), cr, playout,
...
#if 0 /*def DEBUG*/
    {
        ...
        if(!esdesktop_icon_get_position(icon, &row, &col))
            DBG("can't get icon position for '%s'", esdesktop_icon_peek_label(icon));
        else
            DBG("for icon at (%hu,%hu) (%s)", row, col, esdesktop_icon_peek_label(icon));
        ...
        esdesktop_icon_view_shift_area_to_cell(icon_view, icon, &cell);
...
static void
esdesktop_move_all_icons_to_pending_icons_list(EsdesktopIconView *icon_view)
{
    GList *l = NULL;
    ...
    for(l = icon_view->priv->icons; l; l = l->next) {
        ...
        if(esdesktop_icon_get_position(ESDESKTOP_ICON(l->data), &old_row, &old_col))
            esdesktop_grid_set_position_free(icon_view, old_row, old_col);

        g_signal_handlers_disconnect_by_func(G_OBJECT(l->data),
                                             G_CALLBACK(esdesktop_icon_view_icon_changed),
                                             icon_view);
    }
 ...
 * icons list */
static void
esdesktop_move_all_cached_icons_to_desktop(EsdesktopIconView *icon_view)
{
#ifdef ENABLE_FILE_ICONS
    GList *l, *leftovers = NULL;
    EsdesktopFileIconManager *fmanager = NULL;

    DBG("entering");

    if(ESDESKTOP_IS_FILE_ICON_MANAGER(icon_view->priv->manager))
        fmanager = ESDESKTOP_FILE_ICON_MANAGER(icon_view->priv->manager);

    if(fmanager == NULL)
        return;

    esdesktop_file_icon_save(fmanager);

    /* add all cached icons back */
    for(l = icon_view->priv->pending_icons; l; l = l->next) {
        gint16 row, col;
        EsdesktopIcon *icon = ESDESKTOP_ICON(l->data);
        gchar *identifier = esdesktop_icon_get_identifier(icon);

        if(!ESDESKTOP_IS_FILE_ICON(icon))
            continue;

        /* Try to get the cached position for the new resolution */
        if(esdesktop_file_icon_manager_get_cached_icon_position(
                                                            fmanager,
                                                            esdesktop_icon_peek_label(icon),
                                                            identifier,
                                                            &row,
                                                            &col))
        {
            XF_DEBUG("icon %s setting position row%dxcol%d",
                     esdesktop_icon_peek_label(icon), row, col);

            /* Make sure the slot is available */
            if(esdesktop_grid_is_free_position(icon_view, row, col)) {
                esdesktop_icon_set_position(icon, row, col);
                esdesktop_icon_view_add_item_internal(icon_view, icon);
            } else {
...
static void
esdesktop_move_all_previous_icons_to_desktop(EsdesktopIconView *icon_view)
{
    GList *l, *leftovers = NULL;
...
static void
esdesktop_append_all_pending_icons(EsdesktopIconView *icon_view)
{
    GList *l, *leftovers = NULL;
    ...
    for(l = icon_view->priv->pending_icons; l; l = l->next) {
        ...
        if(esdesktop_grid_get_next_free_position(icon_view, &row, &col)) {
            esdesktop_icon_set_position(icon, row, col);
            esdesktop_icon_view_add_item_internal(icon_view, icon);
        } else {
            leftovers = g_list_prepend(leftovers, icon);
...
static void
esdesktop_move_all_pending_icons_to_desktop(EsdesktopIconView *icon_view)
{
    if(!ESDESKTOP_IS_ICON_VIEW(icon_view))
        return;

    if(icon_view->priv->grid_layout == NULL)
        return;

    esdesktop_move_all_cached_icons_to_desktop(icon_view);
    esdesktop_move_all_previous_icons_to_desktop(icon_view);
    esdesktop_append_all_pending_icons(icon_view);
}

static void
esdesktop_grid_do_resize(EsdesktopIconView *icon_view)
{
    ...
    new_size = (guint)new_rows * new_cols * sizeof(EsdesktopIcon *);
...
static gboolean
esdesktop_grid_resize_timeout(gpointer user_data)
{
    EsdesktopIconView *icon_view = user_data;
...
static inline gboolean
esdesktop_grid_is_free_position(EsdesktopIconView *icon_view,
                                gint16 row,
                                gint16 col)
{
    if(icon_view->priv->grid_layout == NULL) {
...
static gboolean
esdesktop_grid_get_next_free_position(EsdesktopIconView *icon_view,
                                      gint16 *row,
                                      gint16 *col)
{
    gint16 i, j, c, r, idx;
...
static inline void
esdesktop_grid_set_position_free(EsdesktopIconView *icon_view,
                                 gint16 row,
                                 gint16 col)
{
...
static inline gboolean
esdesktop_grid_unset_position_free_raw(EsdesktopIconView *icon_view,
                                       gint16 row,
                                       gint16 col,
                                       gpointer data)
{
...
static inline gboolean
esdesktop_grid_unset_position_free(EsdesktopIconView *icon_view,
                                   EsdesktopIcon *icon)
{
    gint16 row, col;
    ...
    return esdesktop_grid_unset_position_free_raw(icon_view, row, col, icon);
}

static inline EsdesktopIcon *
esdesktop_icon_view_icon_in_cell_raw(EsdesktopIconView *icon_view,
                                     gint idx)
{
    EsdesktopIcon *icon = icon_view->priv->grid_layout[idx];
...
static inline EsdesktopIcon *
esdesktop_icon_view_icon_in_cell(EsdesktopIconView *icon_view,
                                 gint16 row,
                                 gint16 col)
{
    gint idx;
    ...
    return esdesktop_icon_view_icon_in_cell_raw(icon_view, idx);
}

static inline gboolean
esdesktop_rectangle_contains_point(GdkRectangle *rect, gint x, gint y)
{
...
static gint
esdesktop_check_icon_clicked(gconstpointer data,
                             gconstpointer user_data)
{
    EsdesktopIcon *icon = ESDESKTOP_ICON(data);
...
static void
esdesktop_list_foreach_invalidate(gpointer data,
                                  gpointer user_data)
{
    EsdesktopIconView *icon_view = ESDESKTOP_ICON_VIEW(user_data);
    EsdesktopIcon *icon = ESDESKTOP_ICON(data);
    esdesktop_icon_view_invalidate_icon(icon_view, icon, TRUE);
}

static void
esdesktop_icon_view_modify_font_size(EsdesktopIconView *icon_view,
                                     gdouble size)
{
...
static void
esdesktop_icon_view_icon_changed(EsdesktopIcon *icon,
                                 gpointer user_data)
{
    /* maybe can pass FALSE here */
    esdesktop_icon_view_invalidate_icon(ESDESKTOP_ICON_VIEW(user_data),
                                        icon, TRUE);
}

static gboolean
esdesktop_icon_view_is_icon_selected(EsdesktopIconView *icon_view,
                                     EsdesktopIcon *icon)
{
...
GtkWidget *
esdesktop_icon_view_new(EsdesktopIconViewManager *manager)
{
    EsdesktopIconView *icon_view;

    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW_MANAGER(manager), NULL);

    icon_view = g_object_new(ESDESKTOP_TYPE_ICON_VIEW, NULL);
    icon_view->priv->manager = manager;

    icon_view->priv->channel = esconf_channel_get(ESDESKTOP_CHANNEL);

    esconf_g_property_bind(icon_view->priv->channel,
...
static void
esdesktop_icon_view_add_item_internal(EsdesktopIconView *icon_view,
                                      EsdesktopIcon *icon)
{
    gint16 row, col;
    ...
    esdesktop_grid_unset_position_free(icon_view, icon);
    ...
    /* paint the icon */
    esdesktop_icon_view_paint_icon(icon_view, icon, &fake_area, cr);
...
static gboolean
esdesktop_icon_view_icon_find_position(EsdesktopIconView *icon_view,
                                       EsdesktopIcon *icon)
{
    gint16 row, col;

    if (!esdesktop_icon_get_position(icon, &row, &col)
        || !esdesktop_grid_is_free_position(icon_view, row, col)
...
void
esdesktop_icon_view_add_item(EsdesktopIconView *icon_view,
                             EsdesktopIcon *icon)
{
    gint16 row, col;
    ...
    g_object_set_data(G_OBJECT(icon), "--esdesktop-icon-view", icon_view);
    ...
    if(!gtk_widget_get_realized(GTK_WIDGET(icon_view))) {
        ...
        if(esdesktop_icon_view_icon_find_position(icon_view, icon))
            esdesktop_icon_view_add_item_internal(icon_view, icon);
        else {
            icon_view->priv->pending_icons = g_list_append(icon_view->priv->pending_icons,
                                                           icon);
...
void
esdesktop_icon_view_remove_item(EsdesktopIconView *icon_view,
                                EsdesktopIcon *icon)
{
    gint16 row, col;
    GList *l;
    ...
    if(l) {
        ...
        if(esdesktop_icon_get_position(icon, &row, &col)) {
            esdesktop_icon_view_invalidate_icon(icon_view, icon, FALSE);
            esdesktop_grid_set_position_free(icon_view, row, col);
        }
        ...
        g_warning("Attempt to remove icon %p from EsdesktopIconView %p, but it's not in there.",
                  icon, icon_view);
        return;
    }

    g_object_set_data(G_OBJECT(icon), "--esdesktop-icon-view", NULL);
...
void
esdesktop_icon_view_remove_all(EsdesktopIconView *icon_view)
{
    GList *l;
    gint16 row, col;
    ...
    for(l = icon_view->priv->icons; l; l = l->next) {
        ...
        g_signal_handlers_disconnect_by_func(G_OBJECT(l->data),
                                             G_CALLBACK(esdesktop_icon_view_icon_changed),
                                             icon_view);
        g_object_set_data(G_OBJECT(l->data), "--esdesktop-icon-view", NULL);
...
void
esdesktop_icon_view_set_selection_mode(EsdesktopIconView *icon_view,
    ...
    switch(mode) {
        case GTK_SELECTION_NONE:
            g_warning("GTK_SELECTION_NONE is not implemented for " \
                      "EsdesktopIconView.  Falling back to " \
        ...
        case GTK_SELECTION_SINGLE:
            if(g_list_length(icon_view->priv->selected_icons) > 1) {
                ...
                for(l = icon_view->priv->selected_icons->next; l; l = l->next) {
                    esdesktop_icon_view_unselect_item(icon_view,
                                                      ESDESKTOP_ICON(l->data));
                }
...
GtkSelectionMode
esdesktop_icon_view_get_selection_mode(EsdesktopIconView *icon_view)
{
    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view),
                         GTK_SELECTION_NONE);
...
void
esdesktop_icon_view_enable_drag_source(EsdesktopIconView *icon_view,
...
void
esdesktop_icon_view_enable_drag_dest(EsdesktopIconView *icon_view,
                                     const GtkTargetEntry *targets,
                                     gint n_targets,
                                     GdkDragAction actions)
{
...
void
esdesktop_icon_view_unset_drag_source(EsdesktopIconView *icon_view)
{
    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view));
...
void
esdesktop_icon_view_unset_drag_dest(EsdesktopIconView *icon_view)
{
    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view));
...
EsdesktopIcon *
esdesktop_icon_view_widget_coords_to_item(EsdesktopIconView *icon_view,
                                          gint wx,
                                          gint wy)
{
    gint16 row, col;

    esdesktop_xy_to_rowcol(icon_view, wx, wy, &row, &col);
    if(row >= icon_view->priv->nrows || col >= icon_view->priv->ncols || row < 0 || col < 0)
    {
        return NULL;
    }

    return esdesktop_icon_view_icon_in_cell(icon_view, row, col);
}

GList *
esdesktop_icon_view_get_selected_items(EsdesktopIconView *icon_view)
{
    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view), NULL);

    return g_list_copy(icon_view->priv->selected_icons);
}

void
esdesktop_icon_view_select_item(EsdesktopIconView *icon_view,
                                EsdesktopIcon *icon)
{
    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view));
    ...
    g_signal_emit(G_OBJECT(icon_view),
                  ...
                  0, NULL);
    esdesktop_icon_selected(icon);
}

void
esdesktop_icon_view_select_all(EsdesktopIconView *icon_view)
{
    GList *l;
    ...
    for(l = icon_view->priv->icons; l; l = l->next) {
        ...
        esdesktop_icon_view_invalidate_icon(icon_view, l->data, TRUE);
        esdesktop_icon_selected(l->data);
    }
...
void
esdesktop_icon_view_unselect_item(EsdesktopIconView *icon_view,
                                  EsdesktopIcon *icon)
{
    GList *l;
...
void
esdesktop_icon_view_unselect_all(EsdesktopIconView *icon_view)
{
    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view));
    ...
    if(icon_view->priv->selected_icons) {
        ...
        icon_view->priv->selected_icons = NULL;
        g_list_foreach(repaint_icons, esdesktop_list_foreach_invalidate,
                       icon_view);
...
void
esdesktop_icon_view_set_icon_size(EsdesktopIconView *icon_view,
                                  guint icon_size)
{
    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view));
...
guint
esdesktop_icon_view_get_icon_size(EsdesktopIconView *icon_view)
{
    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view), 0);
    return icon_view->priv->icon_size;
}

void
esdesktop_icon_view_set_primary(EsdesktopIconView *icon_view,
                                gboolean primary)
{
    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view));
...
void
esdesktop_icon_view_set_font_size(EsdesktopIconView *icon_view,
                                  gdouble font_size_points)
{
    ...
    if(gtk_widget_get_realized(GTK_WIDGET(icon_view))) {
        esdesktop_icon_view_modify_font_size(icon_view, font_size_points);
        esdesktop_grid_do_resize(icon_view);
        gtk_widget_queue_draw(GTK_WIDGET(icon_view));
    }
}
...
gdouble
esdesktop_icon_view_get_font_size(EsdesktopIconView *icon_view)
{
    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view), 0.0);
    return icon_view->priv->font_size;
}

void
esdesktop_icon_view_set_center_text (EsdesktopIconView *icon_view,
                                     gboolean center_text)
{
    g_return_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view));
...
GtkWidget *
esdesktop_icon_view_get_window_widget(EsdesktopIconView *icon_view)
{
    g_return_val_if_fail(ESDESKTOP_IS_ICON_VIEW(icon_view), NULL);
...
#if defined(DEBUG) && DEBUG > 0
guint
_esdesktop_icon_view_n_items(EsdesktopIconView *icon_view)
{
